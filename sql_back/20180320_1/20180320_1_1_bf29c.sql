...
CREATE TABLE `zmkj_admin_log` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=4450 DEFAULT CHARSET=utf8 COMMENT='管理员操作日志';
...
CREATE TABLE `zmkj_album_pic` (
  ...
  `upload_time` int(10) unsigned NOT NULL COMMENT '图片上传时间',
  PRIMARY KEY (`apic_id`)
) ENGINE=MyISAM AUTO_INCREMENT=12774 DEFAULT CHARSET=utf8 COMMENT='相册图片表';
...
) ENGINE=MyISAM AUTO_INCREMENT=374 DEFAULT CHARSET=utf8 COMMENT='商品属性表';
...
) ENGINE=MyISAM AUTO_INCREMENT=3367 DEFAULT CHARSET=utf8 COMMENT='商品属性值表';
...
) ENGINE=MyISAM AUTO_INCREMENT=473 DEFAULT CHARSET=utf8 COMMENT='品牌表';
...
) ENGINE=MyISAM AUTO_INCREMENT=221 DEFAULT CHARSET=utf8 COMMENT='购物车数据表';
...
) ENGINE=MyISAM AUTO_INCREMENT=50 DEFAULT CHARSET=utf8 COMMENT='信誉评价表';
...
) ENGINE=MyISAM AUTO_INCREMENT=15 DEFAULT CHARSET=utf8 COMMENT='店铺评分表';
...
CREATE TABLE `zmkj_exppoints_log` (
  ...
  PRIMARY KEY (`exp_id`)
) ENGINE=MyISAM AUTO_INCREMENT=255 DEFAULT CHARSET=utf8 COMMENT='经验值日志表';
...
CREATE TABLE `zmkj_goods` (
  ...
  PRIMARY KEY (`goods_id`)
) ENGINE=MyISAM AUTO_INCREMENT=102662 DEFAULT CHARSET=utf8 COMMENT='商品表';
...
) ENGINE=MyISAM AUTO_INCREMENT=367 DEFAULT CHARSET=utf8 COMMENT='店铺常用分类表';
...
) ENGINE=MyISAM AUTO_INCREMENT=101638 DEFAULT CHARSET=utf8 COMMENT='商品公共内容表';
...
) ENGINE=MyISAM AUTO_INCREMENT=4994 DEFAULT CHARSET=utf8 COMMENT='商品图片';
...
) ENGINE=MyISAM AUTO_INCREMENT=289 DEFAULT CHARSET=utf8 COMMENT='会员表';
...
) ENGINE=MyISAM AUTO_INCREMENT=422 DEFAULT CHARSET=utf8 COMMENT='短消息';
...
CREATE TABLE `zmkj_order` (
  ...
  PRIMARY KEY (`order_id`)
) ENGINE=MyISAM AUTO_INCREMENT=197 DEFAULT CHARSET=utf8 COMMENT='订单表';
...
CREATE TABLE `zmkj_order_common` (
  ...
  PRIMARY KEY (`order_id`)
) ENGINE=MyISAM AUTO_INCREMENT=197 DEFAULT CHARSET=utf8 COMMENT='订单信息扩展表';
...
) ENGINE=MyISAM AUTO_INCREMENT=202 DEFAULT CHARSET=utf8 COMMENT='订单商品表';
...
CREATE TABLE `zmkj_order_log` (
  ...
  PRIMARY KEY (`log_id`)
) ENGINE=MyISAM AUTO_INCREMENT=440 DEFAULT CHARSET=utf8 COMMENT='订单处理历史表';
...
CREATE TABLE `zmkj_order_pay` (
  ...
  PRIMARY KEY (`pay_id`)
) ENGINE=MyISAM AUTO_INCREMENT=514 DEFAULT CHARSET=utf8 COMMENT='订单支付表';
...
CREATE TABLE `zmkj_pd_log` (
  ...
  PRIMARY KEY (`lg_id`)
) ENGINE=MyISAM AUTO_INCREMENT=65 DEFAULT CHARSET=utf8 COMMENT='预存款变更日志表';
...
CREATE TABLE `zmkj_pd_recharge` (
  ...
  PRIMARY KEY (`pdr_id`)
) ENGINE=MyISAM AUTO_INCREMENT=20 DEFAULT CHARSET=utf8 COMMENT='预存款充值表';
...
CREATE TABLE `zmkj_points_log` (
  ...
  PRIMARY KEY (`pl_id`)
) ENGINE=MyISAM AUTO_INCREMENT=462 DEFAULT CHARSET=utf8 COMMENT='会员积分日志表';
...
) ENGINE=MyISAM AUTO_INCREMENT=76 DEFAULT CHARSET=utf8 COMMENT='退款退货表';
...
CREATE TABLE `zmkj_seller_log` (
  ...
  PRIMARY KEY (`log_id`)
) ENGINE=MyISAM AUTO_INCREMENT=4174 DEFAULT CHARSET=utf8 COMMENT='卖家日志表';
...
CREATE TABLE `zmkj_sns_albumclass` (
  ...
  PRIMARY KEY (`ac_id`)
) ENGINE=MyISAM AUTO_INCREMENT=328 DEFAULT CHARSET=utf8 COMMENT='相册表';
...
CREATE TABLE `zmkj_spec` (
  ...
  PRIMARY KEY (`sp_id`)
) ENGINE=MyISAM AUTO_INCREMENT=73 DEFAULT CHARSET=utf8 COMMENT='商品规格表';
...
) ENGINE=MyISAM AUTO_INCREMENT=1929 DEFAULT CHARSET=utf8 COMMENT='商品规格值表';
...
) ENGINE=MyISAM AUTO_INCREMENT=1252 DEFAULT CHARSET=utf8 COMMENT='店铺动态表';
