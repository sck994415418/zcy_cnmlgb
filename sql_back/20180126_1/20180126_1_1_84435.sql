...
) ENGINE=MyISAM AUTO_INCREMENT=110 DEFAULT CHARSET=utf8 COMMENT='买家地址信息表';
...
CREATE TABLE `zmkj_admin_log` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=2603 DEFAULT CHARSET=utf8 COMMENT='管理员操作日志';
...
CREATE TABLE `zmkj_adv` (
  ...
  PRIMARY KEY (`adv_id`)
) ENGINE=MyISAM AUTO_INCREMENT=945 DEFAULT CHARSET=utf8 COMMENT='广告表';
...
CREATE TABLE `zmkj_adv_position` (
  ...
  PRIMARY KEY (`ap_id`)
) ENGINE=MyISAM AUTO_INCREMENT=1052 DEFAULT CHARSET=utf8 COMMENT='广告位表';
...
) ENGINE=MyISAM AUTO_INCREMENT=58 DEFAULT CHARSET=utf8 COMMENT='相册表';
...
CREATE TABLE `zmkj_album_pic` (
  ...
  `upload_time` int(10) unsigned NOT NULL COMMENT '图片上传时间',
  PRIMARY KEY (`apic_id`)
) ENGINE=MyISAM AUTO_INCREMENT=4494 DEFAULT CHARSET=utf8 COMMENT='相册图片表';
...
) ENGINE=MyISAM AUTO_INCREMENT=227 DEFAULT CHARSET=utf8 COMMENT='商品属性表';
...
) ENGINE=MyISAM AUTO_INCREMENT=3196 DEFAULT CHARSET=utf8 COMMENT='商品属性值表';
...
) ENGINE=MyISAM AUTO_INCREMENT=426 DEFAULT CHARSET=utf8 COMMENT='品牌表';
...
) ENGINE=MyISAM AUTO_INCREMENT=162 DEFAULT CHARSET=utf8 COMMENT='购物车数据表';
...
CREATE TABLE `zmkj_chat_log` (
  ...
  PRIMARY KEY (`m_id`)
) ENGINE=MyISAM AUTO_INCREMENT=11 DEFAULT CHARSET=utf8 COMMENT='消息记录表';
...
CREATE TABLE `zmkj_exppoints_log` (
  ...
  PRIMARY KEY (`exp_id`)
) ENGINE=MyISAM AUTO_INCREMENT=146 DEFAULT CHARSET=utf8 COMMENT='经验值日志表';
...
CREATE TABLE `zmkj_favorites` (
  ...
  PRIMARY KEY (`log_id`),
  KEY `member_id` (`member_id`)
) ENGINE=MyISAM AUTO_INCREMENT=63 DEFAULT CHARSET=utf8 COMMENT='收藏表';
...
CREATE TABLE `zmkj_goods` (
  ...
  PRIMARY KEY (`goods_id`)
) ENGINE=MyISAM AUTO_INCREMENT=100633 DEFAULT CHARSET=utf8 COMMENT='商品表';
...
) ENGINE=MyISAM AUTO_INCREMENT=1730 DEFAULT CHARSET=utf8 COMMENT='商品分类表';
...
) ENGINE=MyISAM AUTO_INCREMENT=206 DEFAULT CHARSET=utf8 COMMENT='店铺常用分类表';
...
) ENGINE=MyISAM AUTO_INCREMENT=100619 DEFAULT CHARSET=utf8 COMMENT='商品公共内容表';
...
) ENGINE=MyISAM AUTO_INCREMENT=2437 DEFAULT CHARSET=utf8 COMMENT='商品图片';
...
CREATE TABLE `zmkj_invoice` (
  ...
  PRIMARY KEY (`inv_id`)
) ENGINE=MyISAM AUTO_INCREMENT=38 DEFAULT CHARSET=utf8 COMMENT='买家发票信息表';
...
) ENGINE=MyISAM AUTO_INCREMENT=217 DEFAULT CHARSET=utf8 COMMENT='短消息';
...
CREATE TABLE `zmkj_order` (
  ...
  PRIMARY KEY (`order_id`)
) ENGINE=MyISAM AUTO_INCREMENT=19 DEFAULT CHARSET=utf8 COMMENT='订单表';
...
CREATE TABLE `zmkj_order_common` (
  ...
  PRIMARY KEY (`order_id`)
) ENGINE=MyISAM AUTO_INCREMENT=19 DEFAULT CHARSET=utf8 COMMENT='订单信息扩展表';
...
) ENGINE=MyISAM AUTO_INCREMENT=15 DEFAULT CHARSET=utf8 COMMENT='订单商品表';
...
CREATE TABLE `zmkj_order_log` (
  ...
  PRIMARY KEY (`log_id`)
) ENGINE=MyISAM AUTO_INCREMENT=238 DEFAULT CHARSET=utf8 COMMENT='订单处理历史表';
...
CREATE TABLE `zmkj_order_pay` (
  ...
  PRIMARY KEY (`pay_id`)
) ENGINE=MyISAM AUTO_INCREMENT=340 DEFAULT CHARSET=utf8 COMMENT='订单支付表';
...
CREATE TABLE `zmkj_points_log` (
  ...
  PRIMARY KEY (`pl_id`)
) ENGINE=MyISAM AUTO_INCREMENT=337 DEFAULT CHARSET=utf8 COMMENT='会员积分日志表';
...
) ENGINE=MyISAM AUTO_INCREMENT=55 DEFAULT CHARSET=utf8 COMMENT='卖家用户表';
...
CREATE TABLE `zmkj_seller_log` (
  ...
  PRIMARY KEY (`log_id`)
) ENGINE=MyISAM AUTO_INCREMENT=1268 DEFAULT CHARSET=utf8 COMMENT='卖家日志表';
...
) ENGINE=MyISAM AUTO_INCREMENT=268 DEFAULT CHARSET=utf8 COMMENT='手机短信记录表';
...
CREATE TABLE `zmkj_sns_albumclass` (
  ...
  PRIMARY KEY (`ac_id`)
) ENGINE=MyISAM AUTO_INCREMENT=308 DEFAULT CHARSET=utf8 COMMENT='相册表';
...
CREATE TABLE `zmkj_spec` (
  ...
  PRIMARY KEY (`sp_id`)
) ENGINE=MyISAM AUTO_INCREMENT=56 DEFAULT CHARSET=utf8 COMMENT='商品规格表';
...
) ENGINE=MyISAM AUTO_INCREMENT=663 DEFAULT CHARSET=utf8 COMMENT='商品规格值表';
...
) ENGINE=MyISAM AUTO_INCREMENT=56 DEFAULT CHARSET=utf8 COMMENT='店铺数据表';
...
CREATE TABLE `zmkj_store_bind_class` (
  ...
  PRIMARY KEY (`bid`),
  KEY `store_id` (`store_id`)
) ENGINE=MyISAM AUTO_INCREMENT=326 DEFAULT CHARSET=utf8 COMMENT='店铺可发布商品类目表';
...
CREATE TABLE `zmkj_store_goods_class` (
  ...
  KEY `store_id` (`store_id`)
) ENGINE=MyISAM AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 COMMENT='店铺商品分类表';
...
) ENGINE=MyISAM AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 COMMENT='店铺动态表';
...
CREATE TABLE `zmkj_store_watermark` (
  ...
  PRIMARY KEY (`wm_id`)
) ENGINE=MyISAM AUTO_INCREMENT=10 DEFAULT CHARSET=utf8 COMMENT='店铺水印图片表';
...
CREATE TABLE `zmkj_type` (
  ...
  PRIMARY KEY (`type_id`)
) ENGINE=MyISAM AUTO_INCREMENT=67 DEFAULT CHARSET=utf8 COMMENT='商品类型表';
...
CREATE TABLE `zmkj_upload` (
  ...
  `item_id` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '信息ID',
  PRIMARY KEY (`upload_id`)
) ENGINE=MyISAM AUTO_INCREMENT=198 DEFAULT CHARSET=utf8 COMMENT='上传文件表';
