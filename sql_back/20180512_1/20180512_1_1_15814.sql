...
) ENGINE=MyISAM AUTO_INCREMENT=132 DEFAULT CHARSET=utf8 COMMENT='买家地址信息表';
...
CREATE TABLE `zmkj_admin_log` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=6489 DEFAULT CHARSET=utf8 COMMENT='管理员操作日志';
...
CREATE TABLE `zmkj_album_pic` (
  ...
  `upload_time` int(10) unsigned NOT NULL COMMENT '图片上传时间',
  PRIMARY KEY (`apic_id`)
) ENGINE=MyISAM AUTO_INCREMENT=13655 DEFAULT CHARSET=utf8 COMMENT='相册图片表';
...
) ENGINE=MyISAM AUTO_INCREMENT=580 DEFAULT CHARSET=utf8 COMMENT='商品属性表';
...
) ENGINE=MyISAM AUTO_INCREMENT=3578 DEFAULT CHARSET=utf8 COMMENT='商品属性值表';
...
) ENGINE=MyISAM AUTO_INCREMENT=293 DEFAULT CHARSET=utf8 COMMENT='购物车数据表';
...
CREATE TABLE `zmkj_chat_log` (
  ...
  PRIMARY KEY (`m_id`)
) ENGINE=MyISAM AUTO_INCREMENT=63 DEFAULT CHARSET=utf8 COMMENT='消息记录表';
...
CREATE TABLE `zmkj_chat_msg` (
  ...
  `add_time` int(10) unsigned DEFAULT '0' COMMENT '添加时间',
  PRIMARY KEY (`m_id`)
) ENGINE=MyISAM AUTO_INCREMENT=63 DEFAULT CHARSET=utf8 COMMENT='消息表';
...
) ENGINE=MyISAM AUTO_INCREMENT=55 DEFAULT CHARSET=utf8 COMMENT='信誉评价表';
...
) ENGINE=MyISAM AUTO_INCREMENT=20 DEFAULT CHARSET=utf8 COMMENT='店铺评分表';
...
CREATE TABLE `zmkj_exppoints_log` (
  ...
  PRIMARY KEY (`exp_id`)
) ENGINE=MyISAM AUTO_INCREMENT=323 DEFAULT CHARSET=utf8 COMMENT='经验值日志表';
...
CREATE TABLE `zmkj_goods` (
  ...
  PRIMARY KEY (`goods_id`)
) ENGINE=MyISAM AUTO_INCREMENT=103650 DEFAULT CHARSET=utf8 COMMENT='商品表';
...
) ENGINE=MyISAM AUTO_INCREMENT=2231 DEFAULT CHARSET=utf8 COMMENT='商品分类表';
...
) ENGINE=MyISAM AUTO_INCREMENT=402 DEFAULT CHARSET=utf8 COMMENT='店铺常用分类表';
...
) ENGINE=MyISAM AUTO_INCREMENT=101804 DEFAULT CHARSET=utf8 COMMENT='商品公共内容表';
...
) ENGINE=MyISAM AUTO_INCREMENT=5515 DEFAULT CHARSET=utf8 COMMENT='商品图片';
...
) ENGINE=MyISAM AUTO_INCREMENT=315 DEFAULT CHARSET=utf8 COMMENT='会员表';
...
) ENGINE=MyISAM AUTO_INCREMENT=465 DEFAULT CHARSET=utf8 COMMENT='短消息';
...
CREATE TABLE `zmkj_order` (
  ...
  PRIMARY KEY (`order_id`)
) ENGINE=MyISAM AUTO_INCREMENT=270 DEFAULT CHARSET=utf8 COMMENT='订单表';
...
CREATE TABLE `zmkj_order_common` (
  ...
  PRIMARY KEY (`order_id`)
) ENGINE=MyISAM AUTO_INCREMENT=270 DEFAULT CHARSET=utf8 COMMENT='订单信息扩展表';
...
) ENGINE=MyISAM AUTO_INCREMENT=304 DEFAULT CHARSET=utf8 COMMENT='订单商品表';
...
CREATE TABLE `zmkj_order_log` (
  ...
  PRIMARY KEY (`log_id`)
) ENGINE=MyISAM AUTO_INCREMENT=514 DEFAULT CHARSET=utf8 COMMENT='订单处理历史表';
...
CREATE TABLE `zmkj_order_pay` (
  ...
  PRIMARY KEY (`pay_id`)
) ENGINE=MyISAM AUTO_INCREMENT=584 DEFAULT CHARSET=utf8 COMMENT='订单支付表';
...
) ENGINE=MyISAM AUTO_INCREMENT=4104 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='商品参数表';
...
) ENGINE=MyISAM AUTO_INCREMENT=6949 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='商品参数值表';
...
CREATE TABLE `zmkj_pd_recharge` (
  ...
  PRIMARY KEY (`pdr_id`)
) ENGINE=MyISAM AUTO_INCREMENT=26 DEFAULT CHARSET=utf8 COMMENT='预存款充值表';
...
CREATE TABLE `zmkj_points_log` (
  ...
  PRIMARY KEY (`pl_id`)
) ENGINE=MyISAM AUTO_INCREMENT=562 DEFAULT CHARSET=utf8 COMMENT='会员积分日志表';
...
CREATE TABLE `zmkj_seller_log` (
  ...
  PRIMARY KEY (`log_id`)
) ENGINE=MyISAM AUTO_INCREMENT=6124 DEFAULT CHARSET=utf8 COMMENT='卖家日志表';
...
CREATE TABLE `zmkj_sns_albumclass` (
  ...
  PRIMARY KEY (`ac_id`)
) ENGINE=MyISAM AUTO_INCREMENT=372 DEFAULT CHARSET=utf8 COMMENT='相册表';
...
CREATE TABLE `zmkj_sns_visitor` (
  ...
  PRIMARY KEY (`v_id`)
) ENGINE=MyISAM AUTO_INCREMENT=7 DEFAULT CHARSET=utf8 COMMENT='sns访客表';
...
CREATE TABLE `zmkj_spec` (
  ...
  PRIMARY KEY (`sp_id`)
) ENGINE=MyISAM AUTO_INCREMENT=92 DEFAULT CHARSET=utf8 COMMENT='商品规格表';
...
) ENGINE=MyISAM AUTO_INCREMENT=2625 DEFAULT CHARSET=utf8 COMMENT='商品规格值表';
...
) ENGINE=MyISAM AUTO_INCREMENT=1428 DEFAULT CHARSET=utf8 COMMENT='店铺动态表';
...
) ENGINE=MyISAM AUTO_INCREMENT=801 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='商品主题表';
...
CREATE TABLE `zmkj_type` (
  ...
  `class_name` varchar(100) NOT NULL COMMENT '所属分类名称',
  PRIMARY KEY (`type_id`)
) ENGINE=MyISAM AUTO_INCREMENT=100 DEFAULT CHARSET=utf8 COMMENT='商品类型表';
