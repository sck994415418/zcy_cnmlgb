...
) ENGINE=MyISAM AUTO_INCREMENT=120 DEFAULT CHARSET=utf8 COMMENT='买家地址信息表';
...
CREATE TABLE `zmkj_admin_log` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=4546 DEFAULT CHARSET=utf8 COMMENT='管理员操作日志';
...
CREATE TABLE `zmkj_album_pic` (
  ...
  `upload_time` int(10) unsigned NOT NULL COMMENT '图片上传时间',
  PRIMARY KEY (`apic_id`)
) ENGINE=MyISAM AUTO_INCREMENT=13012 DEFAULT CHARSET=utf8 COMMENT='相册图片表';
...
) ENGINE=MyISAM AUTO_INCREMENT=380 DEFAULT CHARSET=utf8 COMMENT='商品属性表';
...
) ENGINE=MyISAM AUTO_INCREMENT=3373 DEFAULT CHARSET=utf8 COMMENT='商品属性值表';
...
) ENGINE=MyISAM AUTO_INCREMENT=480 DEFAULT CHARSET=utf8 COMMENT='品牌表';
...
) ENGINE=MyISAM AUTO_INCREMENT=223 DEFAULT CHARSET=utf8 COMMENT='购物车数据表';
...
CREATE TABLE `zmkj_cron` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=91 DEFAULT CHARSET=utf8 COMMENT='任务队列表';
...
) ENGINE=MyISAM AUTO_INCREMENT=52 DEFAULT CHARSET=utf8 COMMENT='信誉评价表';
...
) ENGINE=MyISAM AUTO_INCREMENT=17 DEFAULT CHARSET=utf8 COMMENT='店铺评分表';
...
CREATE TABLE `zmkj_exppoints_log` (
  ...
  PRIMARY KEY (`exp_id`)
) ENGINE=MyISAM AUTO_INCREMENT=272 DEFAULT CHARSET=utf8 COMMENT='经验值日志表';
...
CREATE TABLE `zmkj_goods` (
  ...
  `goods_name` varchar(100) NOT NULL COMMENT '商品名称（+规格名称）',
  ...
  PRIMARY KEY (`goods_id`)
) ENGINE=MyISAM AUTO_INCREMENT=102746 DEFAULT CHARSET=utf8 COMMENT='商品表';
...
) ENGINE=MyISAM AUTO_INCREMENT=2210 DEFAULT CHARSET=utf8 COMMENT='商品分类表';
...
) ENGINE=MyISAM AUTO_INCREMENT=374 DEFAULT CHARSET=utf8 COMMENT='店铺常用分类表';
...
) ENGINE=MyISAM AUTO_INCREMENT=101689 DEFAULT CHARSET=utf8 COMMENT='商品公共内容表';
...
) ENGINE=MyISAM AUTO_INCREMENT=5171 DEFAULT CHARSET=utf8 COMMENT='商品图片';
...
) ENGINE=MyISAM AUTO_INCREMENT=32 DEFAULT CHARSET=utf8 COMMENT='团购商品表';
...
) ENGINE=MyISAM AUTO_INCREMENT=297 DEFAULT CHARSET=utf8 COMMENT='会员表';
...
) ENGINE=MyISAM AUTO_INCREMENT=439 DEFAULT CHARSET=utf8 COMMENT='短消息';
...
CREATE TABLE `zmkj_order` (
  ...
  PRIMARY KEY (`order_id`)
) ENGINE=MyISAM AUTO_INCREMENT=205 DEFAULT CHARSET=utf8 COMMENT='订单表';
...
CREATE TABLE `zmkj_order_common` (
  ...
  PRIMARY KEY (`order_id`)
) ENGINE=MyISAM AUTO_INCREMENT=205 DEFAULT CHARSET=utf8 COMMENT='订单信息扩展表';
...
) ENGINE=MyISAM AUTO_INCREMENT=210 DEFAULT CHARSET=utf8 COMMENT='订单商品表';
...
CREATE TABLE `zmkj_order_log` (
  ...
  PRIMARY KEY (`log_id`)
) ENGINE=MyISAM AUTO_INCREMENT=456 DEFAULT CHARSET=utf8 COMMENT='订单处理历史表';
...
CREATE TABLE `zmkj_order_pay` (
  ...
  PRIMARY KEY (`pay_id`)
) ENGINE=MyISAM AUTO_INCREMENT=522 DEFAULT CHARSET=utf8 COMMENT='订单支付表';
...
) ENGINE=MyISAM AUTO_INCREMENT=23 DEFAULT CHARSET=utf8 COMMENT='限时折扣活动表';
...
) ENGINE=MyISAM AUTO_INCREMENT=45 DEFAULT CHARSET=utf8 COMMENT='限时折扣商品表';
...
CREATE TABLE `zmkj_pd_cash` (
  ...
  PRIMARY KEY (`pdc_id`)
) ENGINE=MyISAM AUTO_INCREMENT=92 DEFAULT CHARSET=utf8 COMMENT='预存款提现记录表';
...
CREATE TABLE `zmkj_pd_log` (
  ...
  PRIMARY KEY (`lg_id`)
) ENGINE=MyISAM AUTO_INCREMENT=70 DEFAULT CHARSET=utf8 COMMENT='预存款变更日志表';
...
CREATE TABLE `zmkj_pd_recharge` (
  ...
  PRIMARY KEY (`pdr_id`)
) ENGINE=MyISAM AUTO_INCREMENT=21 DEFAULT CHARSET=utf8 COMMENT='预存款充值表';
...
CREATE TABLE `zmkj_points_log` (
  ...
  PRIMARY KEY (`pl_id`)
) ENGINE=MyISAM AUTO_INCREMENT=493 DEFAULT CHARSET=utf8 COMMENT='会员积分日志表';
...
CREATE TABLE `zmkj_seller_log` (
  ...
  PRIMARY KEY (`log_id`)
) ENGINE=MyISAM AUTO_INCREMENT=4329 DEFAULT CHARSET=utf8 COMMENT='卖家日志表';
...
CREATE TABLE `zmkj_sns_albumclass` (
  ...
  PRIMARY KEY (`ac_id`)
) ENGINE=MyISAM AUTO_INCREMENT=345 DEFAULT CHARSET=utf8 COMMENT='相册表';
...
CREATE TABLE `zmkj_sns_visitor` (
  ...
  PRIMARY KEY (`v_id`)
) ENGINE=MyISAM AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 COMMENT='sns访客表';
...
CREATE TABLE `zmkj_spec` (
  ...
  PRIMARY KEY (`sp_id`)
) ENGINE=MyISAM AUTO_INCREMENT=74 DEFAULT CHARSET=utf8 COMMENT='商品规格表';
...
) ENGINE=MyISAM AUTO_INCREMENT=2007 DEFAULT CHARSET=utf8 COMMENT='商品规格值表';
...
CREATE TABLE `zmkj_store_cost` (
  ...
  PRIMARY KEY (`cost_id`)
) ENGINE=MyISAM AUTO_INCREMENT=15 DEFAULT CHARSET=utf8 COMMENT='店铺费用表';
...
) ENGINE=MyISAM AUTO_INCREMENT=1307 DEFAULT CHARSET=utf8 COMMENT='店铺动态表';
...
) ENGINE=MyISAM AUTO_INCREMENT=29 DEFAULT CHARSET=utf8 COMMENT='代金券表';
...
) ENGINE=MyISAM AUTO_INCREMENT=20 DEFAULT CHARSET=utf8 COMMENT='代金券模版表';
