...
) ENGINE=MyISAM AUTO_INCREMENT=231 DEFAULT CHARSET=utf8 COMMENT='买家地址信息表';
...
CREATE TABLE `zmkj_admin_log` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=7625 DEFAULT CHARSET=utf8 COMMENT='管理员操作日志';
...
) ENGINE=MyISAM AUTO_INCREMENT=61 DEFAULT CHARSET=utf8 COMMENT='相册表';
...
CREATE TABLE `zmkj_album_pic` (
  ...
  `upload_time` int(10) unsigned NOT NULL COMMENT '图片上传时间',
  PRIMARY KEY (`apic_id`)
) ENGINE=MyISAM AUTO_INCREMENT=23326 DEFAULT CHARSET=utf8 COMMENT='相册图片表';
...
) ENGINE=MyISAM AUTO_INCREMENT=933 DEFAULT CHARSET=utf8 COMMENT='商品属性表';
...
) ENGINE=MyISAM AUTO_INCREMENT=3931 DEFAULT CHARSET=utf8 COMMENT='商品属性值表';
...
) ENGINE=MyISAM AUTO_INCREMENT=509 DEFAULT CHARSET=utf8 COMMENT='品牌表';
...
) ENGINE=MyISAM AUTO_INCREMENT=10530 DEFAULT CHARSET=utf8 COMMENT='购物车数据表';
...
CREATE TABLE `zmkj_chat_log` (
  ...
  PRIMARY KEY (`m_id`)
) ENGINE=MyISAM AUTO_INCREMENT=157 DEFAULT CHARSET=utf8 COMMENT='消息记录表';
...
CREATE TABLE `zmkj_chat_msg` (
  ...
  `add_time` int(10) unsigned DEFAULT '0' COMMENT '添加时间',
  PRIMARY KEY (`m_id`)
) ENGINE=MyISAM AUTO_INCREMENT=157 DEFAULT CHARSET=utf8 COMMENT='消息表';
...
CREATE TABLE `zmkj_cron` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=195 DEFAULT CHARSET=utf8 COMMENT='任务队列表';
...
CREATE TABLE `zmkj_evaluate_goods` (
  ...
  `geval_image` varchar(430) DEFAULT NULL COMMENT '晒单图片',
  PRIMARY KEY (`geval_id`)
) ENGINE=MyISAM AUTO_INCREMENT=2656 DEFAULT CHARSET=utf8 COMMENT='信誉评价表';
...
) ENGINE=MyISAM AUTO_INCREMENT=75 DEFAULT CHARSET=utf8 COMMENT='店铺评分表';
...
CREATE TABLE `zmkj_exppoints_log` (
  ...
  PRIMARY KEY (`exp_id`)
) ENGINE=MyISAM AUTO_INCREMENT=704 DEFAULT CHARSET=utf8 COMMENT='经验值日志表';
...
CREATE TABLE `zmkj_favorites` (
  ...
  PRIMARY KEY (`log_id`),
  KEY `member_id` (`member_id`)
) ENGINE=MyISAM AUTO_INCREMENT=66 DEFAULT CHARSET=utf8 COMMENT='收藏表';
...
CREATE TABLE `zmkj_goods` (
  ...
  `goods_name` varchar(400) NOT NULL COMMENT '商品名称（+规格名称）',
  ...
  `goods_param` text NOT NULL COMMENT '商品主题、参数表（三维数组）',
  `vipprice` decimal(10,2) NOT NULL,
  `gjprice` decimal(10,2) NOT NULL,
  PRIMARY KEY (`goods_id`)
) ENGINE=MyISAM AUTO_INCREMENT=104483 DEFAULT CHARSET=utf8 COMMENT='商品表';

DROP TABLE IF EXISTS `zmkj_goods_attr1_index`;
CREATE TABLE `zmkj_goods_attr1_index` (
  `goods_id` int(10) unsigned NOT NULL COMMENT '商品id',
  `goods_commonid` int(10) unsigned NOT NULL COMMENT '商品公共表id',
  `gc_id` int(10) unsigned NOT NULL COMMENT '商品分类id',
  `type1_id` int(10) unsigned NOT NULL COMMENT '类型id',
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=FIXED COMMENT='商品与参数对应表';
...
) ENGINE=MyISAM AUTO_INCREMENT=2256 DEFAULT CHARSET=utf8 COMMENT='商品分类表';
...
) ENGINE=MyISAM AUTO_INCREMENT=442 DEFAULT CHARSET=utf8 COMMENT='店铺常用分类表';
...
) ENGINE=MyISAM AUTO_INCREMENT=976 DEFAULT CHARSET=utf8 COMMENT='商品推荐组合表';
...
) ENGINE=MyISAM AUTO_INCREMENT=102079 DEFAULT CHARSET=utf8 COMMENT='商品公共内容表';
...
CREATE TABLE `zmkj_goods_gift` (
  ...
  PRIMARY KEY (`gift_id`)
) ENGINE=MyISAM AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 COMMENT='商品赠品表';
...
) ENGINE=MyISAM AUTO_INCREMENT=17187 DEFAULT CHARSET=utf8 COMMENT='商品图片';

DROP TABLE IF EXISTS `zmkj_goods_rent`;
CREATE TABLE `zmkj_goods_rent` (
  `rent_id` int(11) NOT NULL AUTO_INCREMENT COMMENT '主键：自增',
  ...
  `have_gift` tinyint(3) unsigned NOT NULL DEFAULT '0' COMMENT '是否拥有赠品',
  `is_own_shop` tinyint(3) unsigned NOT NULL DEFAULT '0' COMMENT '是否为平台自营',
  `rent_addtime` int(11) NOT NULL COMMENT '租赁开始时间',
  `rent_edittime` int(11) NOT NULL COMMENT '租赁结束时间',
  `rent_short_time` int(11) NOT NULL COMMENT '最短租期(天)',
  `rent_money` decimal(10,2) NOT NULL COMMENT '租金/月',
  `cash_pledge` decimal(10,2) NOT NULL COMMENT '押金',
  `recommend` tinyint(4) NOT NULL DEFAULT '0' COMMENT '租赁首页面推荐',
  `rent_time` int(11) NOT NULL DEFAULT '0' COMMENT '租赁次数',
  `rent_goods_state` tinyint(4) NOT NULL DEFAULT '0' COMMENT '租赁商品状态: 0正常 1取消租赁中',
  PRIMARY KEY (`rent_id`),
  KEY `goods_id` (`goods_id`),
  KEY `rent_id` (`rent_id`)
) ENGINE=MyISAM AUTO_INCREMENT=102027 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='租赁设备表';

DROP TABLE IF EXISTS `zmkj_goods_rent_class`;
CREATE TABLE `zmkj_goods_rent_class` (
  `rent_id` int(10) unsigned NOT NULL COMMENT '自增id ',
  `goods_id` int(10) unsigned NOT NULL COMMENT '商品id',
  `name` int(10) NOT NULL COMMENT '租期',
  `zujin` decimal(10,2) NOT NULL COMMENT '租金',
  `yajin` decimal(10,2) NOT NULL COMMENT '押金',
  `fangshi` varchar(20) NOT NULL COMMENT '方式',
  `add_time` int(11) NOT NULL COMMENT '添加时间'
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='租赁商品规格表';
...
) ENGINE=MyISAM AUTO_INCREMENT=43 DEFAULT CHARSET=utf8 COMMENT='团购商品表';
...
CREATE TABLE `zmkj_invoice` (
  ...
  PRIMARY KEY (`inv_id`)
) ENGINE=MyISAM AUTO_INCREMENT=41 DEFAULT CHARSET=utf8 COMMENT='买家发票信息表';
...
CREATE TABLE `zmkj_mall_consult` (
  ...
  PRIMARY KEY (`mc_id`)
) ENGINE=MyISAM AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='平台客服咨询表';
...
CREATE TABLE `zmkj_member` (
  ...
  `mshenfen_id` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`member_id`),
  KEY `member_name` (`member_name`)
) ENGINE=MyISAM AUTO_INCREMENT=434 DEFAULT CHARSET=utf8 COMMENT='会员表';
...
) ENGINE=MyISAM AUTO_INCREMENT=999 DEFAULT CHARSET=utf8 COMMENT='短消息';
...
DROP TABLE IF EXISTS `zmkj_mshenfen`;
CREATE TABLE `zmkj_mshenfen` (
  `mshenfen_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `mshenfen_name` varchar(32) NOT NULL,
  `mshenfen_sort` tinyint(4) NOT NULL,
  `mshenfen_time` int(11) NOT NULL,
  `is_show` tinyint(4) DEFAULT '0',
  PRIMARY KEY (`mshenfen_id`)
...
CREATE TABLE `zmkj_order` (
  ...
  `is_yanchi` int(4) NOT NULL DEFAULT '0',
  PRIMARY KEY (`order_id`)
) ENGINE=MyISAM AUTO_INCREMENT=555 DEFAULT CHARSET=utf8 COMMENT='订单表';
...
CREATE TABLE `zmkj_order_common` (
  ...
  PRIMARY KEY (`order_id`)
) ENGINE=MyISAM AUTO_INCREMENT=555 DEFAULT CHARSET=utf8 COMMENT='订单信息扩展表';
...
CREATE TABLE `zmkj_order_goods` (
  ...
  `order_id` int(11) NOT NULL COMMENT '订单id',
  `goods_id` int(11) NOT NULL COMMENT '商品id',
  `goods_commonid` int(10) DEFAULT NULL COMMENT '商品公共id',
  `goods_name` varchar(50) NOT NULL COMMENT '商品名称',
  `goods_price` decimal(10,2) NOT NULL COMMENT '商品价格',
  ...
  `goods_type` enum('1','2','3','4','5','6') DEFAULT '1' COMMENT '1默认2团购商品3限时折扣商品4组合套装5赠品6抢购',
...
) ENGINE=MyISAM AUTO_INCREMENT=10301 DEFAULT CHARSET=utf8 COMMENT='订单商品表';
...
CREATE TABLE `zmkj_order_log` (
  ...
  PRIMARY KEY (`log_id`)
) ENGINE=MyISAM AUTO_INCREMENT=1340 DEFAULT CHARSET=utf8 COMMENT='订单处理历史表';
...
CREATE TABLE `zmkj_order_pay` (
  ...
  PRIMARY KEY (`pay_id`)
) ENGINE=MyISAM AUTO_INCREMENT=869 DEFAULT CHARSET=utf8 COMMENT='订单支付表';
...
) ENGINE=MyISAM AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COMMENT='满就送活动表';
...
CREATE TABLE `zmkj_p_mansong_rule` (
  ...
  PRIMARY KEY (`rule_id`)
) ENGINE=MyISAM AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COMMENT='满就送活动规则表';
...
) ENGINE=MyISAM AUTO_INCREMENT=29 DEFAULT CHARSET=utf8 COMMENT='限时折扣活动表';
...
) ENGINE=MyISAM AUTO_INCREMENT=121 DEFAULT CHARSET=utf8 COMMENT='限时折扣商品表';
...
CREATE TABLE `zmkj_p_xianshi_quota` (
  ...
  `end_time` int(10) unsigned NOT NULL COMMENT '套餐结束时间',
  PRIMARY KEY (`quota_id`)
) ENGINE=MyISAM AUTO_INCREMENT=10 DEFAULT CHARSET=utf8 COMMENT='限时折扣套餐表';

DROP TABLE IF EXISTS `zmkj_param`;
CREATE TABLE `zmkj_param` (
  `pr_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '属性id',
  `pr_name` varchar(100) NOT NULL COMMENT '属性名称',
  `title_id` int(10) unsigned NOT NULL COMMENT '所属主题id',
  `pr_value` text NOT NULL COMMENT '属性值列',
  `pr_show` tinyint(1) unsigned NOT NULL COMMENT '是否显示。0为不显示、1为显示',
  `pr_sort` tinyint(1) unsigned NOT NULL COMMENT '排序',
  PRIMARY KEY (`pr_id`),
  KEY `attr_id` (`pr_id`,`title_id`)
) ENGINE=MyISAM AUTO_INCREMENT=4778 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='商品参数表';

DROP TABLE IF EXISTS `zmkj_param_value`;
CREATE TABLE `zmkj_param_value` (
  `pr_value_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '属性值id',
  `pr_value_name` varchar(100) NOT NULL COMMENT '属性值名称',
  `pr_id` int(10) unsigned NOT NULL COMMENT '所属属性id',
  `title_id` int(10) unsigned NOT NULL COMMENT '类型id',
  `pr_value_sort` tinyint(1) unsigned NOT NULL COMMENT '属性值排序',
  PRIMARY KEY (`pr_value_id`)
) ENGINE=MyISAM AUTO_INCREMENT=7623 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='商品参数值表';
...
CREATE TABLE `zmkj_pd_cash` (
  ...
  PRIMARY KEY (`pdc_id`)
) ENGINE=MyISAM AUTO_INCREMENT=96 DEFAULT CHARSET=utf8 COMMENT='预存款提现记录表';
...
CREATE TABLE `zmkj_pd_log` (
  ...
  PRIMARY KEY (`lg_id`)
) ENGINE=MyISAM AUTO_INCREMENT=80 DEFAULT CHARSET=utf8 COMMENT='预存款变更日志表';
...
CREATE TABLE `zmkj_pd_recharge` (
  ...
  PRIMARY KEY (`pdr_id`)
) ENGINE=MyISAM AUTO_INCREMENT=27 DEFAULT CHARSET=utf8 COMMENT='预存款充值表';
...
CREATE TABLE `zmkj_points_log` (
  ...
  PRIMARY KEY (`pl_id`)
) ENGINE=MyISAM AUTO_INCREMENT=1062 DEFAULT CHARSET=utf8 COMMENT='会员积分日志表';
...
) ENGINE=MyISAM AUTO_INCREMENT=78 DEFAULT CHARSET=utf8 COMMENT='退款退货表';
...
CREATE TABLE `zmkj_rent_order` (
  ...
  `buyer_address` text COMMENT '买家地址',
  `add_time` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '订单生成时间',
  `payment_time` int(10) unsigned DEFAULT '0' COMMENT '支付(付款)时间',
  ...
  `order_state` tinyint(4) NOT NULL DEFAULT '2' COMMENT '订单状态：0(已取消);2:未通过申请(默认);10:未付款;20:已付款;30:已发货;40:已收货;50:租赁中;',
  `refund_state` tinyint(1) unsigned DEFAULT '0' COMMENT '退款状态:0是无退款,1是部分退款,2是全部退款',
  `lock_state` tinyint(1) unsigned DEFAULT '0' COMMENT '锁定状态:0是正常,大于0是锁定,默认是0',
  `delete_state` tinyint(4) NOT NULL DEFAULT '0' COMMENT '删除状态0未删除1放入回收站2彻底删除',
  `refund_amount` decimal(10,2) DEFAULT '0.00' COMMENT '退款金额',
  ...
  `shipping_code` varchar(50) DEFAULT '' COMMENT '物流单号',
  `model` text NOT NULL COMMENT '商品型号',
  `other` text NOT NULL COMMENT '备注',
  `store_id` int(11) NOT NULL COMMENT '店铺id',
  `order_end` int(11) NOT NULL COMMENT '结束日期',
  `order_start` int(11) NOT NULL COMMENT '开始日期',
  `goods_num` int(11) NOT NULL DEFAULT '1' COMMENT '商品数量',
  `order_pledge` decimal(10,2) NOT NULL COMMENT '总押金',
  `rent_price` decimal(10,0) NOT NULL COMMENT '租金/月',
  `units` text NOT NULL COMMENT '买家单位名称',
  `rent_time` int(11) NOT NULL COMMENT '租赁时长',
  PRIMARY KEY (`rorder_id`) USING BTREE
) ENGINE=MyISAM AUTO_INCREMENT=168 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='租赁订单表';
...
) ENGINE=MyISAM AUTO_INCREMENT=60 DEFAULT CHARSET=utf8 COMMENT='卖家用户表';
...
CREATE TABLE `zmkj_seller_log` (
  ...
  PRIMARY KEY (`log_id`)
) ENGINE=MyISAM AUTO_INCREMENT=10166 DEFAULT CHARSET=utf8 COMMENT='卖家日志表';
...
) ENGINE=MyISAM AUTO_INCREMENT=272 DEFAULT CHARSET=utf8 COMMENT='手机短信记录表';
...
CREATE TABLE `zmkj_sns_albumclass` (
  ...
  PRIMARY KEY (`ac_id`)
) ENGINE=MyISAM AUTO_INCREMENT=514 DEFAULT CHARSET=utf8 COMMENT='相册表';
...
CREATE TABLE `zmkj_sns_albumpic` (
  ...
  PRIMARY KEY (`ap_id`)
) ENGINE=MyISAM AUTO_INCREMENT=15 DEFAULT CHARSET=utf8 COMMENT='相册图片表';
...
) ENGINE=MyISAM AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COMMENT='共享商品表';
...
CREATE TABLE `zmkj_sns_sharestore` (
  ...
  `share_privacy` tinyint(1) NOT NULL DEFAULT '0' COMMENT '隐私可见度 0所有人可见 1好友可见 2仅自己可见',
  PRIMARY KEY (`share_id`)
) ENGINE=MyISAM AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='共享店铺表';
...
) ENGINE=MyISAM AUTO_INCREMENT=7 DEFAULT CHARSET=utf8 COMMENT='动态信息表';
...
CREATE TABLE `zmkj_sns_visitor` (
  ...
  PRIMARY KEY (`v_id`)
) ENGINE=MyISAM AUTO_INCREMENT=8 DEFAULT CHARSET=utf8 COMMENT='sns访客表';
...
CREATE TABLE `zmkj_spec` (
  ...
  PRIMARY KEY (`sp_id`)
) ENGINE=MyISAM AUTO_INCREMENT=130 DEFAULT CHARSET=utf8 COMMENT='商品规格表';
...
CREATE TABLE `zmkj_spec_value` (
  ...
  `sp_value_name` varchar(500) NOT NULL COMMENT '规格值名称',
...
) ENGINE=MyISAM AUTO_INCREMENT=3289 DEFAULT CHARSET=utf8 COMMENT='商品规格值表';
...
) ENGINE=MyISAM AUTO_INCREMENT=59 DEFAULT CHARSET=utf8 COMMENT='店铺数据表';
...
CREATE TABLE `zmkj_store_bind_class` (
  ...
  PRIMARY KEY (`bid`),
  KEY `store_id` (`store_id`)
) ENGINE=MyISAM AUTO_INCREMENT=333 DEFAULT CHARSET=utf8 COMMENT='店铺可发布商品类目表';
...
CREATE TABLE `zmkj_store_cost` (
  ...
  PRIMARY KEY (`cost_id`)
) ENGINE=MyISAM AUTO_INCREMENT=16 DEFAULT CHARSET=utf8 COMMENT='店铺费用表';
...
) ENGINE=MyISAM AUTO_INCREMENT=18 DEFAULT CHARSET=utf8 COMMENT='店铺装修表';
...
) ENGINE=MyISAM AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='关联板式表';
...
) ENGINE=MyISAM AUTO_INCREMENT=1715 DEFAULT CHARSET=utf8 COMMENT='店铺动态表';
...
DROP TABLE IF EXISTS `zmkj_title`;
CREATE TABLE `zmkj_title` (
  `title_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '类型id',
  `title_name` varchar(100) NOT NULL COMMENT '类型名称',
  `title_sort` tinyint(1) unsigned NOT NULL COMMENT '排序',
  `class_id` int(10) unsigned DEFAULT '0' COMMENT '所属分类id',
  `class_name` varchar(100) NOT NULL COMMENT '所属分类名称',
  PRIMARY KEY (`title_id`)
) ENGINE=MyISAM AUTO_INCREMENT=921 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='商品主题表';
...
CREATE TABLE `zmkj_type` (
  ...
  `class_name` varchar(100) NOT NULL COMMENT '所属分类名称',
  PRIMARY KEY (`type_id`)
) ENGINE=MyISAM AUTO_INCREMENT=143 DEFAULT CHARSET=utf8 COMMENT='商品类型表';
...
CREATE TABLE `zmkj_voucher` (
  ...
  `voucher_type_id` int(11) DEFAULT NULL COMMENT '商品类型id',
...
) ENGINE=MyISAM AUTO_INCREMENT=37 DEFAULT CHARSET=utf8 COMMENT='代金券表';
...
CREATE TABLE `zmkj_voucher_quota` (
  ...
  PRIMARY KEY (`quota_id`)
) ENGINE=MyISAM AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COMMENT='代金券套餐表';
...
CREATE TABLE `zmkj_voucher_template` (
  ...
  `voucher_t_type` tinyint(4) NOT NULL DEFAULT '0' COMMENT '1:分类；2:品牌；0:全品类',
  `voucher_t_type_id` int(11) DEFAULT NULL COMMENT '分类或品牌的id',
  `voucher_t_type_name` char(50) DEFAULT NULL COMMENT '分类或品牌的name',
  PRIMARY KEY (`voucher_t_id`)
) ENGINE=MyISAM AUTO_INCREMENT=25 DEFAULT CHARSET=utf8 COMMENT='代金券模版表';
