...
class process{
	...
	const MAX_LOGIN = 800;	//密码连续输入多少次被暂时锁定
	const MAX_COMMIT = 300;	//连续评论多少次被暂时锁定
	const MAX_REG = 600;		//连续注册多少个账号被暂时锁定
	const MAX_FORGET = 600;	//找回密码输入多少次被暂时锁定
	const MAX_ADMIN = 800;	//后台管理员输入多少次被暂时锁定
