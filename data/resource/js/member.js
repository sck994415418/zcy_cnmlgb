 ...
 function ckAll(){
     var aobj=document.getElementById("all").checked;
     var pobj=document.getElementsByName("checkitem");
...
//判断产品的复选框的勾选个
function is_p_Allselect(){
	
	var aobj=document.getElementById("all");
	var pobj=document.getElementsByName("checkitem");
	if(getCheckNum()==pobj.length){					
			aobj.checked=true;										
	}else{
		aobj.checked=false;
	}
