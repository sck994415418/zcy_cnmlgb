...
class web_chatModel extends Model{
 ...
 $field = 't_id,t_name,max(add_time) as addtime';
	...
	public function getGoodsInfo($goods_id) {
	    ...
	    $field = 'goods_id,store_id,goods_commonid,goods_name,goods_image,goods_price,goods_marketprice,goods_promotion_price,vipprice,gjprice';
	    ...
	    if (is_array($goods) && !empty($goods)) {
	        $goods['url'] = urlShop('goods','index',array('goods_id'=> $goods['goods_id']));
				...
				if ($_SESSION['mshenfen_id'] == 2 && $goods['vipprice'] != '0.00'){
					 $goods['goods_promotion_price'] = ncPriceFormat($goods['vipprice']);
           
				}elseif($_SESSION['mshenfen_id'] == 3 && $goods['gjprice'] != '0.00'){
					 $goods['goods_promotion_price'] = ncPriceFormat($goods['gjprice']);
				}else{
