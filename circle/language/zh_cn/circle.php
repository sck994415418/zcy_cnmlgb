 ...
 * control
 */
$lang['circle_group_not_exists']	= '版块不存在';
$lang['circle_theme_not_exists']	= '帖子不存在';
$lang['circle_grooup_not_create']	= '对不起，管理员已经关闭创建新版块功能。';
$lang['circle_theme_cannot_be_published']	= '网站已经关闭发表帖子功能。';
$lang['circle_has_been_closed_reply']	= '网站已经关闭回复帖子功能 。';
$lang['circle_operation_too_frequent']	= '操作太频繁，请稍后再试。';

/**
 * group_manage
 */
$lang['circle_tclass_max_10']		= '已经创建10个帖子分类，不能在继续创建。';
$lang['circle_tclass_name_not_null']= '请填写分类名称';
$lang['circle_sort_error']			= '排序不能为空且只能填写数字';
$lang['fcircle_please_choose']		= '请选择想要添加的版块';
...
$lang['nc_edit_theme']				= '编辑帖子';
$lang['nc_edit_reply']				= '编辑回复';
$lang['nc_release_new_theme']		= '发布新帖子';
...
$lang['nc_reply_theme']				= '回复帖子';
$lang['nc_read_perm']				= '阅读权限';

// 友情版块
$lang['circle_name']				= '版块名称';
$lang['nc_show']					= '显示';
$lang['nc_hide']					= '隐藏';
$lang['fcircle_add']				= '添加友情版块';
$lang['fcircle_edit']				= '编辑友情版块';
$lang['fcircle_sort']				= '版块排序';
$lang['fcircle_please_choose']		= '请选择版块';
$lang['fcircle_sort_not_null']		= '请填写友情版块排序';

// 基本设置
$lang['circle_desc']				= '版块描述';
$lang['circle_notice']				= '版块公告';
$lang['circle_logo']				= '版块LOGO';
...
$lang['circle_apply_h4']			= '希望您能告诉我们是什么原因使您希望成为本版块管理？';
$lang['circle_apply_h5']			= '例如：本人在线时间长，有充裕的时间管理本版块。';
...
$lang['circle_member_no_join']		= '您不是该版块的成员';
$lang['nc_deit_op_succ']			= '编辑成功';
$lang['circle_member_like_and_show_goods']	= '成员分享和喜欢的商品';
$lang['circle_apply_to_be_a_management']	= '申请成为管理';

// 创建版块
$lang['circle_create_a_group']		= '创建一个版块';
$lang['circle_first_from']			= '欢迎你先在';
$lang['circle_find_like_group']		= '发现喜欢的版块。';
$lang['nc_welcome_at']				= '欢迎在';
$lang['nc_welcome_words']			= '这个快乐和谐的地方，聚集和你爱好相同，品位相当的好朋友，畅谈交流，分享心情，享受生活！';
$lang['circle_allow_create_group_count']	= '最多可创建版块数';
$lang['circle_yet_create_group_count']		= '已经创建版块数';
$lang['circle_allow_join_group_count']	= '最多可加入版块数';
$lang['circle_yet_join_group_count']	= '已经加入版块数';
$lang['circle_belong_to_class']			= '所属类目';
$lang['circle_belong_to_class_tips']	= '根据您的版块主题类型，选择适当的分类。';
$lang['circle_name_tips']				= '版块名称规定使用4~12个字符，确定后不可修改。';
$lang['circle_introduction']			= '版块简介';
$lang['circle_introduction_tips']		= '对您建立的版块进行简单的文字介绍，创建后圈主可做修改，字数不超过255字。';
$lang['circle_tag']						= '版块标签';
$lang['circle_tag_tips']				= '建立版块标签有利于全局搜索查找到您的版块，多个标签请用&quot;,&quot;进行分隔。';
$lang['circle_apply_reason']			= '申请理由';
$lang['circle_apply_reason_tips']		= '认真填写申请版块的理由提交至平台，以确保管理人员及时审核并通过，字数不要超过255字。';
$lang['circle_my_read_carefully_agree']	= '我已认真阅读并同意《';
$lang['circle_notice_for_use']			= '版块使用须知';
$lang['circle_all_terms']				= '》中的所有条款';
$lang['circle_submit_applications']		= '提交申请';
$lang['circle_name_4_to_12_length']		= '版块名称4到12个字符之间';
...
$lang['circle_waiting_verify_prompt']	= '等待申请审核通过后才能发表帖子';
$lang['circle_nospeak_prompt']		= '被禁言，不能在发布帖子。';
$lang['circle_all']					= '全部';
$lang['circle_digest_theme']		= '精品帖子';
...
$lang['circle_no_digest']			= '很遗憾，本圈尚无精华帖子。';
$lang['circle_no_theme']			= '很遗憾，尚无圈友发表的帖子。';
$lang['circle_is_under_approval']	= '版块正在审批中，请稍后再试...';
$lang['circle_approval_fail']		= '很遗憾，该版块审批失败：（';
$lang['circle_reason']				= '原因';
$lang['circle_is_closed']			= '对不起，该版块已被关闭！';
...
$lang['circle_desc_null_default']	= '不相识的你我却拥有相同的爱好，版块让我们距离更近:)';
$lang['circle_no_administrate']		= '暂无管理员';
$lang['circle_create_my_new_circle']= '创建我的新版块';
 ...
 * index
 */
$lang['circle_create_max_error']	= '您所创建的版块已经达到允许创建上限，无法继续创建版块。';
$lang['circle_join_max_error']		= '您所加入的版块已经达到允许加入上限，无法继续创建版块。';
$lang['circle_name_not_null']		= '版块名称不能为空';
$lang['circle_create']				= '创建版块';
...
$lang['my_theme']					= '我的帖子';
$lang['circle_hot_group']			= '热门版块';
$lang['circle_new_theme']			= '新帖子';
$lang['circle_group_member']		= '组员';
$lang['circle_new_member']			= '新成员';
$lang['circle_recommend_group']		= '推荐版块';
$lang['circle_recommend_theme']		= '推荐帖子';
$lang['circle_friend_show_order']	= '圈友晒单';
$lang['circle_excellent_goods']		= '优秀圈成员';

$lang['circle_new_theme_two']		= '最新帖子';
$lang['circle_hot_theme']			= '热门帖子';
$lang['circle_hot_reply']			= '热门回复';
$lang['circle_theme_come_from']		= '帖子来自';
...
$lang['circle_Insufficient_permissions']	= '权限不足，不能查看帖子';
// 详细页
...
$lang['circle_affix_image_title_one']	= '帖子“';
$lang['circle_affix_image_title_two']	= '”中的附件';
$lang['circle_theme_manage']		= '帖子管理';
...
$lang['circle_theme_is_closed']		= '本帖子已经关闭';
$lang['circle_nospeak_reply_prompt']= '被禁言，不能回复帖子。';
$lang['circle_of_reply']			= '的回复';
$lang['circle_share_theme']			= '分享帖子';
$lang['circle_inform_theme']		= '举报帖子';
...
$lang['level_release_theme']	= '发表帖子帖子';
