...
$(function() {
	...
	$.getJSON(ApiUrl + "/index.php?act=member_rent_order&op=order_info", {
		key: e,
		order_id: order_id
	}, function(e) {
		if (e.datas.error) {
		...
		$("#xm").html(e.datas.buyer_name);
		$("#buyer_address").html(e.datas.buyer_address);
		$("#other").html(e.datas.other);
		$("#buyer_phone").html(e.datas.buyer_phone);
		$("#goods_name").html(e.datas.goods_name);
		$("#goods_jingle").html(e.datas.goods_jingle);
		$("#goods_price").html(e.datas.goods_price);
		$("#rorder_id").html(e.datas.rorder_id);
		$("#store_name").html(e.datas.store_name);
		$("#add_time").html(e.datas.add_time);
		$("#img").attr('src',e.datas.goods_image);
	...
	function a(r) {
		$.ajax({
			type: "post",
			url: ApiUrl + "/index.php?act=member_rent_order&op=order_cancel",
			data: {
				order_id: r,
				key: e
			},
	...
	function d() {
		...
		$.ajax({
			type: "post",
			url: ApiUrl + "/index.php?act=member_rent_order&op=resend",
			data: {
				order_id: order_id,
				buyer_phone: r,
				key: e
