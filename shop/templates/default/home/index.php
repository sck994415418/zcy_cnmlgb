...
.left-sidebar .title{ text-align:center}
</style>
<div class="clear"></div>
    ...
    <div class="cmtleft">
      <div id="con">
        <ul>
          ...
          <?php }?>
          <?php }else{?>
          <a target="_blank" title="商家合作" href="<?php echo urlShop('show_joinin', 'index');?>"> <img width="978" height="248" data-url="<?php echo UPLOAD_SITE_URL;?>/shop/common/i_store_joinio.png" rel="lazy" alt="" src="<?php echo UPLOAD_SITE_URL;?>/shop/common/loading.gif"></a>
          <?php }?>
        </ul>
      </div>
    </div>
      ...
      <div class="noticecon">
        <div class="proclamation">
          <div class="tabs-panel">
            <div class="tabs-panel"> <a href="<?php echo urlShop('show_joinin', 'index');?>" title="商家合作" class="store-join-btn" target="_blank">商家合作</a> <a href="<?php echo urlShop('seller_login','show_login');?>" target="_blank" class="store-join-help"><i class="icon-cog"></i>登录商家中心</a> </div>
            <ul class="mall-news">
...
<div id="nav_box">
  <ul>
    <li class="nav_h_1"><a class="num">办公设备</a></li>
    <li class="nav_h_2"><a class="num">办公耗材</a></li>
    <li class="nav_h_3"><a class="num">办公用纸</a></li>
    <li class="nav_h_4"><a class="num">办公文具</a></li>
    <li class="nav_h_4"><a class="num">办公家具</a></li>
  </ul>
</div>
<!--StandardLayout End-->
<!--判断限时折扣是否显示,如果显示则隐藏本周推荐-->
<script type="text/javascript">
	var xianshi = document.getElementById('xianshi');
	var recom_goods = document.getElementById('recom_goods');
	if(xianshi){
		recom_goods.style.display = 'none';
	}
</script>
