                ...
                <?php foreach ($output['goods_list'] as $value) { ?>
                    <li>
                        ...
                        <dl class="goods-info">
                            ...
                            <dd class="goods-price">商城价：<em><?php echo $lang['currency']; ?>
                                    <?php
                                    if ($_SESSION['mshenfen_id'] == 2 && $value['vipprice'] != 0) {
                                        echo $value['vipprice'] > $value['goods_promotion_price'] ? $value['goods_promotion_price'] : $value['vipprice'];
                                    } elseif ($_SESSION['mshenfen_id'] == 3 && $value['gjprice'] != 0) {
                                        echo $value['gjprice'] > $value['goods_promotion_price'] ? $value['goods_promotion_price'] : $value['gjprice'];
                                    } else {
