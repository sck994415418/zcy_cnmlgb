      ...
      <ul>
        ...
        <li class="<?php echo $output['current']; ?>">
          <div class="ncg-list-content"> 
          	<a title="<?php echo $groupbuy['groupbuy_name'];?>" href="<?php echo $groupbuy['groupbuy_url'];?>" class="pic-thumb" target="_blank">
          		<img src="<?php echo UPLOAD_SITE_URL;?>/shop/common/loading.gif" rel="lazy" data-url="<?php echo gthumb($groupbuy['groupbuy_image'],'mid');?>" alt="" >
          			<?php if($groupbuy['goods_storage']<=0){?>
          			<img src="<?php echo SHOP_SITE_URL;?>/templates/default/images/sale_out.jpg" style=" position: absolute;display: block; top:80px;left:170px;"/>
          			<?php }?>
          		</a>
            ...
            <div class="item-prices"> <span class="price"><i><?php echo $lang['currency'];?></i><?php echo $integer_part;?><em>.<?php echo $decimal_part;?></em></span>
              ...
              <span class="sold-num"><!--多少件已购买-->
              	<em><?php echo $groupbuy['buy_quantity']+$groupbuy['virtual_quantity'];?></em>
              	<?php echo $lang['text_piece'];?><?php echo $lang['text_buy'];?>              		
              </span><!--我要抢            判断  库存>0 我要买   库存小于0 已抢购完-->  
              	<!--<a href="<?php echo $groupbuy['groupbuy_url'];?>" target="_blank" class="buy-button"><?php echo $output['buy_button'];?></a>-->
              	<?php if($groupbuy['goods_storage']>0){?>
              			<a href="<?php echo $groupbuy['groupbuy_url'];?>" target="_blank" class="buy-button"><?php echo $output['buy_button'];?>
              		<?php }else{?>
              			<a  class="buy-button" style="background-color: darkgray;"><?php echo '已售完';?>
