...
<?php if (!empty($output['goods_list']) && is_array($output['goods_list'])) { ?>
        ...
        <?php if (!empty($value['image'])) { ?>
                            ...
                            <div class="goods-price"> <em class="sale-price" title="<?php
                                ...
                                echo $lang['goods_class_index_store_goods_price'] . $lang['nc_colon'] . $lang['currency'] . $rs;
                                //echo $lang['goods_class_index_store_goods_price'] . $lang['nc_colon'] . $lang['currency'] . $value['goods_promotion_price']; 
                                ?>"><?php
                                                              if ($_SESSION['mshenfen_id'] == 2 && $value['vipprice'] != 0) {
                                                                  $rs = $value['vipprice'] > $value['goods_promotion_price'] ? $value['goods_promotion_price'] : $value['vipprice'];
                                                              } elseif ($_SESSION['mshenfen_id'] == 3 && $value['gjprice'] != 0) {
                                                              ...
                                                              echo ncPriceFormatForList($rs);
                                                              //echo ncPriceFormatForList($value['goods_promotion_price']); 
                                                              ?></em> <em class="market-price" title="市场价：<?php echo $lang['currency'] . $value['goods_marketprice']; ?>"><?php echo ncPriceFormatForList($value['goods_marketprice']); ?></em> <span class="raty" data-score="<?php echo $value['evaluation_good_star']; ?>"></span> </div>   
                            <div class="sell-stat">
                                <ul>
