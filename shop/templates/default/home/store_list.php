        ...
        <li>
            <dl>
              ...
              <dd class="goods-name"><a href="<?php echo urlShop('goods','',array('goods_id'=>$v['goods_id']));?>" title="<?php echo $v['goods_name'];?>" target="_blank"><?php echo $v['goods_name'];?></a></dd>
				...
				<?php if($v['vipprice'] != '0.00' && $_SESSION['mshenfen_id'] == 2){?>
					<dd class="goods-price"><em><?php echo $v['vipprice'];?></em></dd>
				<?php }else if($v['gjprice'] != '0.00' && $_SESSION['mshenfen_id'] == 3){?>	
					<dd class="goods-price"><em><?php echo $v['gjprice'];?></em></dd>
				<?php }else{?>
