...
$(document).ready(function(){
  ...
  <div id="apply_agreement" class="apply-agreement">
    <div class="title"><h3>合作协议</h3></div>
    ...
    <div class="bottom">
		<a id="btn_apply_agreement_c2c_next" href="javascript:;" class="btn">个人合作</a>
		<a id="btn_apply_agreement_next" href="javascript:;" class="btn">企业合作</a>
	</div>
  </div>
