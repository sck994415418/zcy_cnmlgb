  ...
  <div class="user-box">
    ...
    <div class="user-joinin">
      ...
      <dl>
        ...
        <dd> 若您还没有填写合作申请资料<br/>
          请点击“<a href="<?php echo urlShop('store_joinin', 'step0');?>" target="_blank">我要入住</a>”进行合作资料填写</dd>
        <dd>若您的店铺还未开通<br/>
          请通过“<a href="<?php echo urlShop('store_joinin', 'index');?>" target="_blank">查看合作进度</a>”了解店铺开通的最新状况 </dd>
      </dl>
      <div class="bottom"><a href="<?php echo urlShop('store_joinin', 'step0');?>" target="_blank">我要入住</a><a href="<?php echo urlShop('store_joinin', 'index');?>" target="_blank">查看合作进度</a></div>
    </div>
     <?php }else { ?>
...
<div class="main mt30">
  <h2 class="index-title">合作流程</h2>
  <div class="joinin-index-step"><span class="step"><i class="a"></i>签署合作协议</span><span class="arrow"></span><span class="step"><i class="b"></i>商家信息提交</span><span class="arrow"></span><span class="step"><i class="c"></i>平台审核资质</span><span class="arrow"></span><span class="step"><i class="d"></i>商家缴纳费用</span><span class="arrow"></span><span class="step"><i class="e"></i>店铺开通</span></div>
  <h2 class="index-title">合作指南</h2>
