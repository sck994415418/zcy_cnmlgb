...
<div style="position: fixed; bottom: 200px; left: 16px;width: 50px;">
	<a target="_blank" href="http://wpa.qq.com/msgrd?v=3&uin=2533917151&site=qq&menu=yes"><img style="width:100%;height:auto;" border="0" src="http://wpa.qq.com/pa?p=2:2533917151:53" alt="欢迎光临诺融网上平台" title="欢迎光临诺融网上平台"/></a>
</div>
<div id="faq">
...
<div class="help">
    ...
    <img src="<?php echo UPLOAD_SITE_URL.DS.ATTACH_COMMON.DS.$GLOBALS['setting_config']['site_logowx']; ?>" class="f-l jImg img-error">
        				...
        				<div class="weibo f-l">
        					<div class="ic qq" style="padding-left: 0px;"><?php echo rec(11);?></div>
        					<div class="ic sina" style="padding-left: 0px;"><?php echo rec(8);?></div>
        				</div>
        			</div>
    			</div>
    		</div>
...
河北诺融网络科技有限公司 版权所有 &nbsp;&nbsp;<script type="text/javascript">var cnzz_protocol = (("https:" == document.location.protocol) ? " https://" : " http://");document.write(unescape("%3Cspan id='cnzz_stat_icon_1273007677'%3E%3C/span%3E%3Cscript src='" + cnzz_protocol + "s13.cnzz.com/z_stat.php%3Fid%3D1273007677%26show%3Dpic' type='text/javascript'%3E%3C/script%3E"));</script>
  <a href="http://www.beian.miit.gov.cn/" target="_blank">
  <?php echo html_entity_decode($output['setting_config']['statistics_code'],ENT_QUOTES); ?><br/><?php echo $output['setting_config']['icp_number']; ?></a></div>
<?php if (C('debug') == 1){?>
