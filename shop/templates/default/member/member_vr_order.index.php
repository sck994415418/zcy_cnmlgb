    ...
    <tbody>
      ...
      <tr>
        ...
        <td> <?php if($order_info['if_refund']){ ?>
          <a href="index.php?act=member_vr_refund&op=add_refund&order_id=<?php echo $order_info['rorder_id']; ?>">退款</a>
          <?php } ?></td>
        ...
        <td class="bdl"><p><?php echo $order_info['state_desc'];?></p>
          <p><a href="index.php?act=member_vr_order&op=show_order&order_id=<?php echo $order_info['rorder_id'];?>">订单详情</a></p></td>
        <td class="bdl bdr">

          <!--取消订单-->
          <?php if ($order_info['order_state'] != 0){ ?>
          <p class="mt5"><a class="ncm-btn ncm-btn-red" href="index.php?act=member_vr_order&op=change_state&state_type=order_cancel&order_id=<?php echo $order_info['rorder_id'];?>"><i class="icon-ban-circle"></i>取消订单</a></p>
          <?php }?>
