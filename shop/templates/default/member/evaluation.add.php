...
<div class="ncm-flow-layout">
  <div class="ncm-flow-container">
    ...
    <form id="evalform" method="post" action="index.php?act=member_evaluate&op=<?php echo $_GET['op'];?>&order_id=<?php echo $_GET['order_id'];?>" enctype="multipart/form-data">
        ...
        <tbody>
          ...
          <tr class="bd-line">
            ...
            <td valign="top" class="tr">
            		<textarea name="goods[<?php echo $goods['goods_id'];?>][comment]" cols="150" style="width: 280px;"></textarea>
            		<div style="color: red;padding-right: 200px;">最多上传5张图片</div>
<!--图片-->    <input type="file" name="file[<?php echo $goods['goods_id'];?>][image][]"  multiple="multiple"> 
            </td>
          </tr>
          <?php }?>
          <?php }?>
