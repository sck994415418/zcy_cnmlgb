    ...
    ?>">
        ...
        <div class="ncsc-form-goods">
            ...
            <dl>
                ...
                <dd id="gcategory"> <?php echo $output['goods_class']['gc_tag_name']; ?> <a class="ncsc-btn" href="<?php
                    if ($output['edit_goods_sign']) {
            ...
            <dl>
                ...
                <dd>
                    <input name="g_name" type="text" class="text w400" value="<?php echo $output['goods']['goods_name']; ?>" <?php echo!empty($output['goods_handle_type']) ? "readonly" : ""; ?>/>
                    <?php
                    if (!empty($output['goods_handle_type'])) {
                        echo "<a href='index.php?act=store_goods_online&op=edit_image&commonid=" . $output['goods']['goods_commonid'] . "&#maodian'>编辑</a>";
                    } else {
                        echo "<span></span>";
                    }
                    ?>
                    <p class="hint"><?php
                        if (!empty($output['goods_handle_type'])) {
                            echo $output['goods_handle_type'];
                        } else {
                            echo $lang['store_goods_index_goods_name_help'];
                        }
                        ?></p>
                </dd>
            </dl>
            ...
            <dl>
                <dt><i class="required">*</i>vip价格<?php echo $lang['nc_colon']; ?></dt>
                <dd>
                    <input name="g_vip_price" value="<?php echo $output['goods']['vipprice']; ?>" type="text" class="text w60" /><em class="add-on"><i class="icon-renminbi"></i></em> <span></span>
                    <p class="hint"><?php echo $lang['store_goods_index_store_price_help']; ?>，此价格仅为市场参考售价，请根据该实际情况认真填写。</p>
                </dd>
            </dl>
            <dl>
                <dt><i class="required">*</i>高级价格<?php echo $lang['nc_colon']; ?></dt>
                <dd>
                    <input name="g_gj_price" value="<?php echo $output['goods']['gjprice']; ?>" type="text" class="text w60" /><em class="add-on"><i class="icon-renminbi"></i></em> <span></span>
                    <p class="hint"><?php echo $lang['store_goods_index_store_price_help']; ?>，此价格仅为市场参考售价，请根据该实际情况认真填写。</p>
                </dd>
            </dl>
            <dl>
            ...
            <?php if (is_array($output['spec_list']) && !empty($output['spec_list'])) { ?>
                ...
                <?php foreach ($output['spec_list'] as $k => $val) { ?>
                    <dl nc_type="spec_group_dl_<?php echo $i; ?>" nctype="spec_group_dl" class="spec-bg" <?php if ($k == '1') { ?>spec_img="t"<?php } ?>>
                        <dt>
                            <input name="sp_name[<?php echo $k; ?>]" type="text" class="text w60 tip2 tr" title="自定义规格类型名称，规格值名称最多不超过4个字" value="<?php
                            if (isset($output['goods']['spec_name'][$k])) {
                                echo $output['goods']['spec_name'][$k];
                            } else {
                                echo $val['sp_name'];
                            }
                            ?>" maxlength="4" nctype="spec_name" data-param="{id:<?php echo $k; ?>,name:'<?php echo $val['sp_name']; ?>'}"/>
                            ...
                            <ul class="spec">
                                ...
                                <li data-param="{gc_id:<?php echo $output['goods_class']['gc_id']; ?>,sp_id:<?php echo $k; ?>,url:'<?php echo urlShop('store_goods_add', 'ajax_add_spec'); ?>'}">
                                    ...
                                    <div nctype="specAdd2" style="display:none;">
                                        <input class="text w60" type="text" placeholder="规格值名称" maxlength="80">
                ...
                <dd class="spec-dd">
                    <table border="0" cellpadding="0" cellspacing="0" class="spec_table">
                        <thead>
                            <?php if (is_array($output['spec_list']) && !empty($output['spec_list'])) { ?>
                                <?php foreach ($output['spec_list'] as $k => $val) { ?>
                                <th nctype="spec_name_<?php echo $k; ?>"><?php
                                    if (isset($output['goods']['spec_name'][$k])) {
                                        echo $output['goods']['spec_name'][$k];
                                    } else {
                                        echo $val['sp_name'];
                        ...
                        <th class="w90"><span class="red">*</span><?php echo "VIP价格"; ?>
                            <div class="batch"><i class="icon-edit" title="批量操作"></i>
                                <div class="batch-input" style="display:none;">
                                    <h6>批量设置价格：</h6>
                                    <a href="javascript:void(0)" class="close">X</a>
                                    <input name="" type="text" class="text vipprice" />
                                    <a href="javascript:void(0)" class="ncsc-btn-mini" data-type="vipprice">设置</a><span class="arrow"></span></div>
                            </div></th>
                        <th class="w90"><span class="red">*</span><?php echo "高级价格"; ?>
                            <div class="batch"><i class="icon-edit" title="批量操作"></i>
                                <div class="batch-input" style="display:none;">
                                    <h6>批量设置价格：</h6>
                                    <a href="javascript:void(0)" class="close">X</a>
                                    <input name="" type="text" class="text gjprice" />
                                    <a href="javascript:void(0)" class="ncsc-btn-mini" data-type="gjprice">设置</a><span class="arrow"></span></div>
                            </div></th>
                        ...
                        <?php foreach ($output['attr_list'] as $k => $val) { ?>
                            <span class="mr30">
                                ...
                                <?php if (is_array($val) && !empty($val)) { ?>       
                                    <?php if (!empty($val['value'][0]['attr_value_name'])) { ?> 
                                    ...
                                    <?php } else {
                                        ?>
                                        <input type="hidden" name="attr[<?php echo $k; ?>][name]" value="<?php echo $val['attr_name'] ?>" />
                                        <input type="text" style="line-height:20px;height:21px;width:100px;margin-top:1px"  class="text w180" name="attr[<?php echo $k; ?>][<?php echo $val['value'][0]['attr_value_id']; ?>]" value="<?php echo $output['goods_common_attr'][$k]; ?>" placeholder="请手动输入属性值" />   <?php echo $id; ?>
                                        <?php
                                    }
                                }
                                ?>
            ...
            <?php if ($output['goods_class']['gc_virtual'] == 1) { ?>
                ...
                <dl class="special-01" nctype="virtual_valid" <?php if ($output['goods']['is_virtual'] == 0) { ?>style="display:none;"<?php } ?>>
                    ...
                    <dd>
                        <input type="text" name="g_vindate" id="g_vindate" class="w80 text" value="<?php
                        if ($output['goods']['is_virtual'] == 1 && !empty($output['goods']['virtual_indate'])) {
                ...
                <dl class="special-01" nctype="virtual_valid" <?php if ($output['goods']['is_virtual'] == 0) { ?>style="display:none;"<?php } ?>>
                    ...
                    <dd>
                        <input type="text" name="g_vlimit" id="g_vlimit" class="w80 text" value="<?php
                        if ($output['goods']['is_virtual'] == 1) {
            ...
            <dl class="special-03" nctype="is_presell" <?php if ($output['goods']['is_presell'] == 0) { ?>style="display:none;"<?php } ?>>
                ...
                <dd>
                    <input type="text" name="g_deliverdate" id="g_deliverdate" class="w80 text" value="<?php
                    if ($output['goods']['presell_deliverdate'] > 0) {
            ...
            <dl nctype="is_appoint"  <?php if ($output['goods']['is_appoint'] == 0) { ?>style="display:none;"<?php } ?>>
                ...
                <dd>
                    <input type="text" name="g_saledate" id="g_saledate" class="w80 text" value="<?php
                    if ($output['goods']['appoint_satedate'] > 0) {
            ...
            <label class="submit-border">
                <input type="submit" class="submit" value="<?php
                       if ($output['edit_goods_sign']) {
                           ...
                           ?><?php echo $lang['store_goods_add_next']; ?>，上传商品图片<?php } ?>" />
            </label>
        </div>
    </form>
</div>
<script type="text/javascript">
    ...
    $.validator.addMethod('checkvipPrice', function(value, element){
    _g_price = parseFloat($('input[name="g_price"]').val());
    _g_vipprice = parseFloat($('input[name="g_vipprice"]').val());
    if (_g_vipprice > _g_price) {
    return false;
    } else {
    return true;
    }
    }, '<i class="icon-exclamation-sign"></i>商品vip价格不能高于商品价格');
...
<?php if (!$output['edit_goods_sign']) { ?>required	: function() {if ($("#is_fc_1").prop("checked")) {return true; } else {return false; }},<?php } ?>
            ...
            required    : '<i class="icon-exclamation-sign"></i><?php echo $lang['store_goods_index_goods_name_null']; ?>',
                    ...
                    //0508 miao
                    g_vip_price : {
                    required    : '<i class="icon-exclamation-sign"></i>请填写vip价格',
                            number      : '<i class="icon-exclamation-sign"></i>请填写正确的价格',
                            min         : '<i class="icon-exclamation-sign"></i>请填写0.01~9999999之间的数字',
                            max         : '<i class="icon-exclamation-sign"></i>请填写0.01~9999999之间的数字'
                    },
                    g_gj_price : {
                    required    : '<i class="icon-exclamation-sign"></i>请填写高级价格',
                            number      : '<i class="icon-exclamation-sign"></i>请填写正确的价格',
                            min         : '<i class="icon-exclamation-sign"></i>请填写0.01~9999999之间的数字',
                            max         : '<i class="icon-exclamation-sign"></i>请填写0.01~9999999之间的数字'
                    },
...
// 生成库存配置
    ...
    //0508 miao
    $('input[name="g_vip_price"]').attr('readonly', 'readonly').css('background', '#E7E7E7 none');
    $('input[name="g_gj_price"]').attr('readonly', 'readonly').css('background', '#E7E7E7 none');
...
<?php recursionSpec(0, $output['sign_i']); ?>
    ...
    $('input[name="g_vip_price"]').removeAttr('readonly').css('background', '');
    $('input[name="g_gj_price"]').removeAttr('readonly').css('background', '');
    ...
    if ($(this).attr('data_type') == 'vipprice' && $(this).val() == ''){
    $(this).val($('input[name="g_vip_price"]').val());
    }
    if ($(this).attr('data_type') == 'gjprice' && $(this).val() == ''){
    $(this).val($('input[name="g_gj_price"]').val());
    }
    ...
    computePrice(); // 价格计算
            ...
            .find('input[data_type="vipprice"]').change(function(){
    computevipPrice(); // vip价格计算
    }).end()
            .find('input[data_type="gjprice"]').change(function(){
    computegjPrice(); // 高级价格计算
    }).end()
...
<?php if (!empty($output['goods']) && $_GET['class_id'] <= 0 && !empty($output['sp_value']) && !empty($output['spec_checked']) && !empty($output['spec_list'])) { ?>
    ...
    ?>
        ...
        if (E_SP[s] != ''){
        $(this).val(E_SP[s]);
        v.html('<input type="text" maxlength="80" value="' + E_SP[s] + '" />');
        } else{
        v.html('<input type="text" maxlength="80" value="' + v.html() + '" />');
        }
    ...
    <?php recursionSpec(0, $output['sign_i']); ?>
        ...
        $('input[name="g_price"]').removeAttr('readonly').css('background', '');
        //2018-5-3
        $('input[name="g_vipprice"]').removeAttr('readonly').css('background', '');
        $('input[name="g_gjprice"]').removeAttr('readonly').css('background', '');
        $('input[name="g_storage"]').removeAttr('readonly').css('background', '');
        } else{
        $('tbody[nc_type="spec_table"]').empty().html(str)
                .find('input[nc_type]').each(function(){
