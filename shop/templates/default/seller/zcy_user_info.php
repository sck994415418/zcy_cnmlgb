...
<div class="toDisplay">
    <form name="yingshe" id="yingshe" action="#" method="post">
        ...
        <table width="300" height="300" border="0" style="margin:auto;">
            <tr>
                <th colspan="2" align="center"><h2 align="center">政采云信息配置</h2></th>
            </tr>
            <tr>
                <td align="right"><font color="#FF0000">*</font>appkey：</td>
                <td><input type="text" name="appkey" id="appkey" value="<?php echo $output['zcy_user_config']['appkey']?$output['zcy_user_config']['appkey']:'';?>" size="40" /></td>
            </tr>
            <tr>
                <td width="35%" align="right"><font color="#FF0000">*</font>secret：</td>
                <td><input type="text" name="appsecret" id="appsecret" value="<?php echo $output['zcy_user_config']['appsecret']?$output['zcy_user_config']['appsecret']:'';?>" size="40" /></td>
            </tr>
            <tr>
...
<script language="javascript">
    ...
    $("#addyingshe").click(function() {
        $.ajax({
            url:"/shop/index.php?act=zcy_user_info&op=update_config",
            type: "POST",
            dataType: "JSON",
