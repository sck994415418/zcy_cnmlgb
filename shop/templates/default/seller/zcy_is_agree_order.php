...
<div class="toDisplay">
    <form name="yingshe" id="yingshe" action="#" method="post">
        ...
        <table width="450" height="500" border="0" style="margin:auto;">
            <tr>
                <th colspan="2" align="center"><h2 align="center">同意|取消订单</h2></th>
            </tr>
            <tr>
                <td width="35%" align="right"><font color="#FF0000">*</font>是否同意取消订单：</td>
                <td width="35%">
                    <input type="radio" name="isAgree" id="shipmentType" value="true" checked size="10" />是
                    <input type="radio" name="isAgree" id="shipmentType" value="false" size="10" />否
                </td>
            </tr>
            <tr>
                <td align="right"><font color="#FF0000"></font>理由：</td>
                <td>
                    <textarea name="comment" id="" cols="30" placeholder="拒绝取消订单时，必须不为空" rows="10"></textarea>
                </td>
            </tr>
            <tr>
...
<script language="javascript">
    $("#addyingshe").click(function() {
        $.ajax({
            url:"/shop/index.php?act=zcy_order&op=is_agree_order",
            type: "POST",
            dataType: "JSON",
