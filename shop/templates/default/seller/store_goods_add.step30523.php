...
?>">
    ...
    <?php if (!empty($output['value_array'])) { ?>
        <div class="ncsc-form-goods-pic">
            ...
            <!--商品table-->
            <div id="goods_list">
                <table border="1px" style="width:73%">
                    <thead>
                    ...
                    <tbody>  
                        <?php foreach ($output['goods_info1'] as $goods) { ?>
                            <tr>
                                <td>
                                    <span style="line-height:15px"><?php echo $goods['goods_name']; ?></span>
                                ...
                                <td><a href="http://www.nrwspt.com/shop/index.php?act=store_goods_add&op=goodsParam&goods_id=<?php echo $goods['goods_id']; ?>" style="padding:8px;border:1px solid #ccc" target="_parent">商品规格和参数</a></td>
                            </tr>       
                        <?php } ?>
                    </tbody>
                </table>
