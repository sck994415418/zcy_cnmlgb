...
if ($output['edit_goods_sign']) {
    echo urlShop('store_goods_online', 'edit_save_goods_imageOp');
} else {
    echo urlShop('store_goods_online', 'save_goods_image');
}
?>">
    ...
    <div class="bottom tc hr16" style="width:890px"><label class="submit-border"><div class="submit"><a href="http://www.nrwspt.com/shop/index.php?act=store_goods_online&op=edit_image&commonid=<?php echo $output['common_list']['goods_commonid']; ?>" style="color:#666">返回<?php print_r($common_list); ?></a></div></label>&nbsp;&nbsp;&nbsp;&nbsp;<label class="submit-border"><input type="submit" class="submit" value="<?php
        if ($output['edit_goods_sign']) {
			echo '提交';
		} else {
      ?> 保存<?php } ?>" /></label></div>
