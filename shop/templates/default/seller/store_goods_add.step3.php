                    ...
                    <tbody>  
                        <?php foreach ($output['goods_info1'] as $goods) { ?>
                            <tr>
                                ...
                                <td>
                                    <a href="index.php?act=store_goods_add&op=goodsParam&goods_id=<?php echo $goods['goods_id']; ?>&edit_goods_sign=<?php echo $output['edit_goods_sign'] ? $output['edit_goods_sign'] : 0; ?>" style="padding:8px;border:1px solid #ccc" target="_parent">商品规格和参数</a>
                                    <a href="index.php?act=store_goods_online&op=edit_goods_image&goods_id=<?php echo $goods['goods_id']; ?>" style="padding:8px;border:1px solid #ccc">商品图片</a></td>
                            </tr>       
                        <?php } ?>
                    </tbody>
                </table>
