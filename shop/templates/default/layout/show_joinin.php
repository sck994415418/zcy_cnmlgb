		  ...
		  <?php if($_SESSION['is_login'] == '1'){?>
			<div class="user-joinin">
				  ...
				  <dl>
					...
					<dd> 若您还没有填写合作申请资料<br/>
					  请点击“<a href="<?php echo urlShop('store_joinin','step0');?>" target="_blank">我要合作</a>”进行合作资料填写</dd>
					<dd>若您的店铺还未开通<br/>
					  请通过“<a href="<?php echo urlShop('store_joinin','index');?>" target="_blank">查看合作进度</a>”了解店铺开通的最新状况 </dd>
				  </dl>
				  <div class="bottom"><a href="<?php echo urlShop('store_joinin','step0');?>" target="_blank">我要合作</a><a href="<?php echo urlShop('store_joinin','index');?>" target="_blank">查看合作进度</a></div>
			</div>
		  <?php }else{?>
...
<div class="main mt30">
  ...
  <div class="joinin-index-step">
	<span class="step"><i class="a"></i>签署合作协议</span><span class="arrow"></span>
