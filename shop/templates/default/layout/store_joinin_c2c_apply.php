...
<div class="breadcrumb"><span class="icon-home"></span><span><a href="<?php echo SHOP_SITE_URL;?>">首页</a></span> <span class="arrow">></span> <span>商家合作</span> </div>
<div class="main">
  <div class="sidebar">
    <div class="title">
      <h3>商家合作</h3>
    ...
    <div class="content">
                  <!--<dl show_id="99">
        <dt onclick="show_list('99');" style="cursor: pointer;"> <i class="hide"></i>合作流程</dt>
        <dd style="display:none;">
          <ul>
                                    <li> <i></i>
                            <a href="index.php?act=show_help&op=index&t_id=99&help_id=101" target="_blank">签署合作协议</a>
                          </li>
                        <li> <i></i>
                  ...
                  <dl>
        <dt class="<?php echo $output['sub_step'] == 'step0' ? 'current' : '';?>"> <i class="hide"></i>签订合作协议</dt>
      </dl>
      <dl show_id="0">
  ...
  <div class="right-layout">
    <div class="joinin-step">
      <ul>
        <li class="step1 <?php echo $output['sub_step'] >= 'step0' ? 'current' : '';?><?php echo $output['sub_step'] == 'pay' ? 'current' : '';?>"><span>签订合作协议</span></li>
