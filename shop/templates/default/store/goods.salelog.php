...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="mt10">
  <thead>
    <tr>
      ...
      <th class="w100" style ="display:none"><?php echo $lang['goods_index_buy_price'];?></th>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td style ="display:none"><em class="price"><?php echo $lang['currency'].$sale['goods_price'];?></em> <i style="color:red;"><?php echo $output['order_type'][$sale['goods_type']];?></i></td>
