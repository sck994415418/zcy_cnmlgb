                                ...
                                <div id="t" class="ncs-commend-floor">
                                    ...
                                    <dl class="detail">
                                        ...
                                        <?php if (!empty($v['geval_second_content'])) { ?>    
                                            <dd class="content">追加评价：<span><?php echo $v['geval_content']; ?></span></dd>                    
                                        <?php } ?>    
                                        <?php if (!empty($v['geval_second_explain'])) { ?>
                                            <dd class="explain"><?php echo $lang['nc_credit_explain']; ?>：<span><?php echo $v['geval_second_explain']; ?></span></dd>
                                        <?php } ?>
                                    </dl>
                                </div>
                            <?php } ?>
