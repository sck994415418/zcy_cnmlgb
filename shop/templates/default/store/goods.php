    ...
    <div class="ncs-detail<?php if ($output['store_info']['is_own_shop']) echo ' ownshop'; ?>"> 
        ...
        <div id="ncs-goods-picture" class="ncs-goods-picture">
            <div class="gallery_wrap">
                <div class="gallery"><img title="鼠标滚轮向上或向下滚动，能放大或缩小图片哦~" src="<?php echo $output["goods_image"]["0"]["2"] ?>" class="cloudzoom" data-cloudzoom="zoomImage: '<?php echo $output["goods_image"]["0"]["2"] ?>'"> </div>
            </div>
                ...
                <div class="controller">
                    <ul>
                        ...
                        foreach ($output["goods_image"] as $key => $value) {
                            ?>
                            <li><img title="鼠标滚轮向上或向下滚动，能放大或缩小图片哦~" class='cloudzoom-gallery' src="<?php echo $value['2'] ?>" data-cloudzoom="useZoom: '.cloudzoom', image: '<?php echo $value['2'] ?>', zoomImage: '<?php echo $value['2'] ?>' " width="60" height="60"></li>
                        <?php } ?>
                    </ul>
                </div>
            </div>
        ...
        <div class="ncs-goods-summary">
            <div class="name">
                <h1 style="word-break: break-all"><?php echo $output['goods']['goods_name']; ?></h1>
            ...
            <div class="ncs-meta"> 
                ...
                <!-- E 商品参考价格 --> 
                <!-- S 商品发布价格 -->
                <?php if ($output['is_jibie'] == 1) { ?>
                    <dl>
                        <dt><?php echo 'vip价格'; ?><?php echo $lang['nc_colon']; ?></dt>
                        <dd class="price">
                            <?php if (isset($output['goods']['promotion_price']) && !empty($output['goods']['promotion_price'])) { ?>
                                <strong><?php echo $lang['currency']; ?>


                                    <?php if (ncPriceFormat($output['goods']['vipprice']) != '0.00' && $output['goods']['vipprice'] < $output['goods']['promotion_price']) { ?>
                                        <?php echo ncPriceFormat($output['goods']['vipprice']); ?>
                                    <?php } else { ?>
                                        <?php echo ncPriceFormat($output['goods']['promotion_price']); ?>
                                    <?php } ?>

                                </strong><em>(原售价<?php echo $lang['nc_colon']; ?><?php echo $lang['currency'] . ncPriceFormat($output['goods']['goods_price']); ?>)</em>
                            <?php } else { ?>
                                <?php if (ncPriceFormat($output['goods']['vipprice']) == '0.00') { ?>
                                    <strong><?php echo $lang['currency'] . ncPriceFormat($output['goods']['goods_price']); ?></strong>
                                <?php } else { ?>
                                    <strong><?php echo $lang['currency'] . ncPriceFormat($output['goods']['vipprice']); ?></strong>
                                <?php } ?>
                            <?php } ?>
                        </dd>
                    </dl>
                    <?php
                } elseif ($output['is_jibie'] == 2) {
                    ?>
                    <dl>
                        <dt><?php echo '高级价格'; ?><?php echo $lang['nc_colon']; ?></dt>
                        <dd class="price">
                            <?php if (isset($output['goods']['promotion_price']) && !empty($output['goods']['promotion_price'])) { ?>
                                <strong><?php echo $lang['currency']; ?>

                                    <?php if (ncPriceFormat($output['goods']['gjprice']) == '0.00' && $output['goods']['gjprice'] < $output['goods']['promotion_price']) { ?>
                                        <?php echo $lang['currency'] . ncPriceFormat($output['goods']['gjprice']); ?>
                                    <?php } else { ?>
                                        <?php echo ncPriceFormat($output['goods']['promotion_price']); ?>
                                    <?php } ?>
                            ...
                            <?php } else { ?>
                                <?php if (ncPriceFormat($output['goods']['vipprice']) == '0.00') { ?>
                                    <strong><?php echo $lang['currency'] . ncPriceFormat($output['goods']['goods_price']); ?></strong>
                                <?php } else { ?>
                                    <strong><?php echo $lang['currency'] . ncPriceFormat($output['goods']['gjprice']); ?></strong>
                                <?php } ?>
                            <?php } ?>
                        </dd>
                    </dl>
                    ...
                    <dl>
                        ...
                        <dd class="price">
                            <?php if (isset($output['goods']['promotion_price']) && !empty($output['goods']['promotion_price'])) { ?>
                                <strong><?php echo $lang['currency']; ?><?php echo ncPriceFormat($output['goods']['promotion_price']); ?>
                                </strong><em>(原售价<?php echo $lang['nc_colon']; ?><?php echo $lang['currency'] . ncPriceFormat($output['goods']['goods_price']); ?>)</em>
                            <?php } else { ?>
                                <strong><?php echo $lang['currency'] . ncPriceFormat($output['goods']['goods_price']); ?></strong>
                            <?php } ?>
                                ...
                                <dd class="promotion-info">
                                    ...
                                    <?php if ($output['mansong_info']) { ?>
                                        <div class="ncs-mansong"> <span class="sale-name">满即送</span> <span class="sale-rule">
                                                <?php
                                                $rule = $output['mansong_info']['rules'][0];
                                                echo $lang['nc_man'];
                                                ?>
                ...
                <?php if ($output['store_info']['store_free_time'] >= '1') { ?>
                    <dl>
                        ...
                        <dd>由 <a href="<?php echo urlShop('show_store', 'index', array('store_id' => $output['store_info']['store_id']), $output['store_info']['store_domain']); ?>" title="进入店铺" ><font color="#D93600"><b><?php echo $output['store_info']['store_name']; ?></b></font></a> 发货并提供售后服务。<span id="store-free-time">18:00 前完成下单，预计(<font color="#D93600"><b>
                                    ...
                                    echo date('m月d日', strtotime($showtime . '+' . $output['store_info']['store_free_time'] . ' day'));
                                    ?>
                                </b></font>) 送达</span></dd>
                    </dl>
                <?php } ?>
                                ...
                                <?php if ($output['goods']['goods_id'] != $goods_commend['goods_id']) { ?>
                                    <li>
                                        <dl>
                                            ...
                                            <dd class="goods-price"><?php echo $lang['currency']; ?>
                                                <?php if ($goods_commend['vipprice'] != '0.00' && $_SESSION['mshenfen_id'] == 2) { ?>
                                                    <?php echo $goods_commend['vipprice'] ?>
                                                <?php } else if ($goods_commend['gjprice'] != '0.00' && $_SESSION['mshenfen_id'] == 3) { ?>	
                                                    <?php echo $goods_commend['gjprice'] ?>
                                                <?php } else { ?>
                                                    <?php echo $goods_commend['goods_price']; ?>
                                                <?php } ?>
