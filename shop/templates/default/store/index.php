  ...
  <div class="ncs-main">
    <div class="flexslider">
      <ul class="slides">
        ...
        <?php }?>
        <?php }else{?>
        <li><img src="<?php echo UPLOAD_SITE_URL.'/'.ATTACH_SLIDE.DS;?>f05.jpg"></li>
        ...
        <ul>
          ...
          <li>
            <dl>
              ...
              <dd class="goods-info"><span class="price"><i><?php echo $lang['currency'];?></i> 
			  
				<?php if($value['vipprice'] != '0.00' && $_SESSION['mshenfen_id'] == 2){?>
					<?php echo $value['vipprice']?> 
				<?php }else if($value['gjprice'] != '0.00' && $_SESSION['mshenfen_id'] == 3){?>	
					<?php echo $value['gjprice']?>
				<?php }else{?>
					 <?php echo $value['goods_promotion_price']?>
				<?php }?>
			  </span> <span class="goods-sold"><?php echo $lang['show_store_index_be_sold'];?><strong><?php echo $value['goods_salenum'];?></strong> <?php echo $lang['nc_jian'];?></span></dd>
