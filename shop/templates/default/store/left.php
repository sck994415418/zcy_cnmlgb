      ...
      <ol>
        ...
        <li>
          <dl>
			...
			<?php if($val['goods_promotion_price']>$val['vipprice'] && $val['vipprice'] != '0.00' && $_SESSION['mshenfen_id'] == 2){?>
				<dd class="price pngFix"><?php echo $val['vipprice']?></dd>
			<?php }else if($val['goods_promotion_price']>$val['gjprice'] && $val['gjprice'] != '0.00' && $_SESSION['mshenfen_id'] == 3){?>	
				<dd class="price pngFix"><?php echo $val['gjprice']?></dd>
			<?php }else{?>
