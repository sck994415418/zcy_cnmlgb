...
<div class="nch-container wrapper">
            ...
            <li>
              <div class="goods-pic">
                <a href="<?php echo urlShop('goods','index',array('goods_id'=>$v['goods_id'])); ?>">
                  <img src="<?php echo UPLOAD_SITE_URL;?>/shop/common/loading.gif" rel="lazy" data-url="<?php echo thumb($v, 60); ?>" title="<?php echo $v['goods_name']; ?>" alt="<?php echo $v['goods_name']; ?>" >
                </a>
              </div>
              <dl>
  ...
  <div class="right">
    <div class="shop_con_list" id="main-nav-holder">
      ...
      <!-- 商品列表循环  -->
      <?php require_once (BASE_TPL_PATH.'/home/aa.goods.squares.php');?>
