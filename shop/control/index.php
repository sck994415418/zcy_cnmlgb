...
class indexControl extends BaseHomeControl{
	...
	public function indexOp(){
		...
		//热门晒单 v3-b12
		$condition['geval_goodsid'] = array('neq',NULL);
		$condition['geval_goodsname'] = array('neq',NULL);
		$condition['geval_ordergoodsid'] = array('neq',NULL);
    	$goods_evaluate_info = Model('evaluate_goods')->getEvaluateGoodsList($condition,6);
