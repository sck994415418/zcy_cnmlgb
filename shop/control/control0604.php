    ...
    private function _getMenuList() {
        $menu_list = array(
                'trade' => array('name' => '交易管理', 'child' => array(
                        'member_order'      => array('name' => '交易订单', 'url'=>urlShop('member_order', 'index')),
//                      'member_wxorder'      => array('name' => '维修订单', 'url'=>urlShop('member_wxorder', 'index')),
//                      'member_vr_order'   => array('name' => '租赁订单', 'url'=>urlShop('member_vr_order','index')),
    ...
    private function _getMenuList() {
        $menu_list = array(
            'goods' => array('name' => '商品', 'child' => array(
		        ...
		        array('name' => '租赁中的商品', 'act' => 'store_rent_orders', 'op'=>'rent_goods'),
            ...
            'order' => array('name' => '订单物流', 'child' => array(
                ...
                // array('name' => '维修订单', 'act'=>'store_wxorder', 'op'=>'index'),
				// array('name' => '租赁订单', 'act'=>'store_vr_order', 'op'=>'index'),
				array('name' => '租赁订单', 'act'=>'store_rent_order', 'op'=>'index'),
