        ...
        if ($browselist){
            ...
            foreach ($browselist as $k=>$v){
                if ($goods_list[$k]){
					...
					if ($_SESSION['mshenfen_id'] == 2 && $tmp['vipprice'] != '0.00'){
						$tmp['goods_promotion_price'] = $tmp['vipprice'];
					}elseif($_SESSION['mshenfen_id'] == 3 && $tmp['gjprice'] != '0.00'){
						$tmp['goods_promotion_price'] = $tmp['gjprice'];
					} 
