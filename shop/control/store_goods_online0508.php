...
class store_goods_onlineControl extends BaseSellerControl {
    ...
    public function edit_goodsOp() {
        ...
        // 取得商品规格的输入值
        $goods_array = $model_goods->getGoodsList($where, 'goods_id,goods_commonid,goods_marketprice,goods_price,goods_storage,goods_serial,goods_storage_alarm,goods_spec');
        $sp_value = array();
