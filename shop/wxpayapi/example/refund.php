...
//	$input->SetOut_trade_no($order['order_sn']);         //自己的订单号 
	...
	if($arr['return_code'] == 'SUCCESS'){
		$refund_fee = $arr['total_fee']/100;
		$transaction_id = $arr['transaction_id'];
		header("location:http://www.nrwspt.com/admin/index.php?act=vr_order&op=wx_state&refund_amount=".$refund_fee."&trade_no=".$transaction_id);
		exit();
	}else{
