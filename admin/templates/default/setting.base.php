...
<tr>
        ...
        <tr>
          <td colspan="2" class="required"><label for="closed_reason">维修师傅上门费用:</label></td>
        </tr>
        <tr class="noborder">
          <td class="vatop rowform"><input type="text" name="smcost" value="<?php echo $output['list_setting']['smcost'];?>" placeholder=""></td>
          <td class="vatop tips"></td>
        </tr>
        <tr>
          <td colspan="2" class="required"><label for="closed_reason">快报:</label></td>
        </tr>
        <tr class="noborder">
          <td class="vatop rowform"><input type="text" name="kuaibao" value="<?php echo $output['list_setting']['kuaibao'];?>" placeholder=""></td>
          <td class="vatop tips"></td>
        </tr>
        <tr>
          <td colspan="2" class="required"><label for="closed_reason">师傅端公告:</label></td>
        </tr>
        <tr class="noborder">
          <td class="vatop rowform">
            <!-- <input type="text" name="gonggao" value="" placeholder=""> -->
            <textarea name="gonggao" style="height:120px;"><?php echo $output['list_setting']['gonggao'];?></textarea>
          </td>
          <td class="vatop tips"></td>
        </tr>
        <tr>
          <td colspan="2" class="required"><label for="closed_reason">提现说明:</label></td>
        </tr>
        <tr class="noborder">
          <td class="vatop rowform">
            <textarea name="txsm" style="height:120px;"><?php echo $output['list_setting']['txsm'];?></textarea>
          </td>
          <td class="vatop tips"></td>
        </tr>
      </tbody>
