...
<div class="page">
  ...
  <table class="table tb-type2 nobdb">
    ...
    <tbody>
      ...
      <tr class="bd-line" >
        ...
        <td class="align-center">
          <a href="index.php?act=refund&op=view&refund_id=<?php echo $val['refund_id']; ?>"> <?php echo $lang['nc_view'];?> </a>
          <?php if($val['refund_state'] == 3 && $val['seller_state'] == 2 && $val['paytype'] == 'zfb' && $val['paystate'] != 1){ ?>
            |<a href="/shop/refund_fastpay/alipayapi.php?WIDbatch_no=<?php echo $val['pay']['WIDbatch_no']; ?>&WIDbatch_num=<?php echo $val['pay']['WIDbatch_num']; ?>&WIDdetail_data=<?php echo $val['pay']['WIDdetail_data']; ?>">退款</a>
          <?php } ?>
          <?php if($val['refund_state'] == 3 && $val['seller_state'] == 2 && $val['paytype'] == 'wx' && $val['paystate'] != 1){ ?>
            |<a href="/shop/wxpayapi/example/refund.php?transaction_id=<?php echo $val['pay']['transaction_id']; ?>&total_fee=<?php echo $val['pay']['total_fee']; ?>&refund_fee=<?php echo $val['pay']['refund_fee']; ?>">退款</a>
          <?php } ?>
		  <?php if($val['refund_state'] == 3 && $val['seller_state'] == 2 && $val['paytype'] == 'allinpay' && $val['paystate'] != 1){ ?>
            |<a href="/shop/api/payment/allinpay/refund.php?order_no=<?php echo $val['pay']['order_no']; ?>&refund_amount=<?php echo $val['pay']['refund_amount']; ?>&order_datetime=<?php echo $val['pay']['order_datetime']; ?>">退款</a>
          <?php } ?>
          <?php if($val['refund_state'] == 3 && $val['seller_state'] == 2 && $val['paystate'] == 1){ ?>
            |已退款
          <?php } ?>
        </td>
      </tr>
    ...
    <tbody>
      <tr class="no_data">
        <td colspan="20"><?php echo $lang['no_record'
