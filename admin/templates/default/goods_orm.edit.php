...
<div class="page">
    ...
    <form id="type_form" method="post">
        ...
        <input type="hidden" name='id' value="<?php echo $output['goods_orm_info']['id']; ?>" />
        <style>
            td{
                line-height:60px;
            }
            ...
            <tbody>
                <tr>
                    <td class="required" colspan="2">
                        ...
                        <input type="text" style="width:180px" class="txt" name="sku" value="<?php echo $output['goods_orm_info']['skuid']; ?>" required />
                    </td>
                </tr> 
                <tr>
                    <td class="required" colspan="2">
                        <label class="validation" for="sku">政府商品id：</label>
                        <input type="text" style="width:180px" class="txt" name="productId" value="<?php echo $output['goods_orm_info']['productId']; ?>" required />
                    </td>
                </tr>
                <tr>
                    <td class="required" colspan="2">
                        <label class="validation" for="sku">政府商品名字：</label>
                        <input type="text" style="width:180px" class="txt" name="productName" value="<?php echo $output['goods_orm_info']['productName']; ?>" required />
                    </td>
                </tr>
                <tr>
                    <td class="required" colspan="2">
                        <label class="validation" for="sku">政府商品平均价格：</label>
                        <input type="text" style="width:180px" class="txt" name="average_price" value="<?php echo $output['goods_orm_info']['average_price']; ?>" />
                    </td>
                </tr>
            </tbody>
        </table>
