  ...
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base">
        ...
        <li><a href="<?php echo urlAdmin('rent', 'equip', array('type' => 'lockup'));?>"><span><?php echo $lang['goods_index_lock_goods'];?></span></a></li>
      ...
      <tbody>
        ...
        <tr class="hover edit">
          ...
          <td class="align-center"><p><?php echo $output['verify'][$v['goods_verify']];?></p>
            ...
            <?php }?></td>
          <td class="w48 align-center"><a href="<?php echo urlShop('goods', 'index', array('goods_id' => $output['storage_array'][$v['goods_commonid']]['goods_id']));?>" target="_blank"><?php echo $lang['nc_view'];?></a>&nbsp;|&nbsp;
            <a href="javascript:void(0);" onclick="rent_verify(<?php echo $v['goods_commonid'];?>);">审核</a></td>
        </tr>
...
// 商品下架
function rent_verify(ids) {
    _uri = "<?php echo ADMIN_SITE_URL;?>/index.php?act=rent&op=rent_verify&id=" + ids;
