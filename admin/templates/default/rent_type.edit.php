      ...
      <tbody>
        <tr class="noborder">
          <td colspan="2" class="required">
            <label class="gc_name validation" for="gc_name"><?php echo $lang['goods_class_index_name'];?>:</label>
          </td>
        </tr>
        <tr class="noborder">
          <td class="vatop rowform">
            <input type="text" maxlength="20" value="<?php echo $output['class_array']['gc_name'];?>" name="gc_name" id="gc_name" class="txt">
          </td>
          <td class="vatop tips"></td>
        </tr>
        <?php if ($output['class_array']['gc_parent_id'] == 0) {?>
        <tr>
          <td colspan="2" class="required"><label for="pic"><?php echo '分类图片';?>:</label>
          </td>
        </tr>
        <tr class="noborder">
          <td class="vatop rowform">
        ...
        <tr>
          <td colspan="2" class="required">
            <label class="validation"><?php echo $lang['goods_class_add_type'];?>:</label>
          </td>
        </tr>
        <tr class="noborder">
          <td colspan="2" id="gcategory">
            <select class="class-select">
              ...
              <?php } ?>
              <?php } ?>
            </select><?php echo $lang['nc_quickly_targeted'];?>
          </td>
        </tr>
        <tr class="noborder">
              ...
              <div class="container">
                <dl>
                  <dd>
                    ...
                    <?php echo $lang['goods_class_null_type'];?>
                  </dd>
                </dl>
          ...
          <td class="vatop tips"><?php echo $lang['goods_class_add_type_desc_one'];?><a onclick="window.parent.openItem('type,type,goods')" href="JavaScript:void(0);"><?php echo $lang['nc_type_manage'];?></a><?php echo $lang['goods_class_add_type_desc_two'];?>
          </td>
        </tr>
        <tr>
