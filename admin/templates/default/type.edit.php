...
<!--添加属性-->
        ...
        <tr>
          ...
          <th><?php echo $lang['type_add_attr_name'];?></th><!--属性名称-->
          <th><?php echo $lang['type_add_attr_value'];?></th><!--属性可选值-->
...
<!--当textarea为空时：默认input输入框；当textarea不为空时，默认select输入框。-->
      ...
      <tbody>
        <tr>
          <td colspan="3"><a id="add_type" class="btn-add marginleft" href="JavaScript:void(0);"> <span><?php echo $lang['type_add_attr_add_one'];?></span> </a></td>
