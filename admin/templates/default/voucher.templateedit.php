...
<!--        代金券使用对象开始-->
         <tr class="noborder">
          <td colspan="2" class="required"><label>使用对象：</label></td>
        </tr>
         <tr class="noborder">
          <td class="vatop rowform">
              <?php if($output['t_info']['voucher_t_type']==0){?>
              <input type="text" class="readonly txt" value="<?php echo "全品类";?>" readonly>
              <?php }elseif($output['t_info']['voucher_t_type']==1){?>
              <span style="color:red">分类：</span><input type="text" class="readonly txt" value="<?php echo $output['t_info']['voucher_t_type_name'];?>" readonly>
              <?php }elseif($output['t_info']['voucher_t_type']==2){?>
              <span style="color:red">品牌：</span><input type="text" class="readonly txt" value="<?php echo $output['t_info']['voucher_t_type_name'];?>" readonly>
              <?php }?>
          </td>
          <td class="vatop tips"></td>
        </tr>
