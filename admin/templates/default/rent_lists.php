...
<div class="page">
  ...
  <form method="get" action="index.php" name="formSearch" id="formSearch">
    ...
    <input type="hidden" name="op" value="rent_lists" />
    <table class="tb-type1 noborder search">
      <tbody>
        <tr>
         <th><label><?php echo $lang['order_number'];?></label></th>
         <td><input class="txt2" type="text" name="rorder_sn" value="<?php echo $_GET['rorder_sn'];?>" /></td>
  ...
  <table class="table tb-type2 nobdb">
    ...
    <tbody>
      ...
      <tr class="hover">
        ...
        <td class="align-center">线下支付</td>
        <td class="align-center"><?php echo orderState($order);?></td>
        <td class="w144 align-center">
          <a href="index.php?act=rent&op=rent_detail&rorder_id=<?php echo $order['rorder_id'];?>">
