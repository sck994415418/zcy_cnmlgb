      ...
      <tr>
        <td>
          <ul>
            ...
            <li>
              <strong>
                <?php echo $lang['tel_phone'];?><?php echo $lang['nc_colon'];?>
              </strong>
              <?php echo @$output['order_info']['buyer_phone'];?>
            </li>
            <li>
              <strong>
                <?php echo $lang['address'];?><?php echo $lang['nc_colon'];?>
              </strong>
              <?php echo @$output['order_info']['buyer_address'];?>
            </li>
          </ul>
        </td>
          </tr>
        ...
        <td><table class="table tb-type2 goods ">
            <tbody>
              ...
              <tr>
                ...
                <td class="w96 align-center"><span class="red_common"><?php echo $lang['currency'].intval($goods['goods_num'])*$goods['goods_price'];?></span></td>
