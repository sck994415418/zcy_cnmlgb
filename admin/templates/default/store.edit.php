  ...
  <div class="homepage-focus" nctype="editStoreContent">
    ...
    <table class="table tb-type2">
      <tbody>
        ...
        <tr>
          <td colspan="2" class="required"><label class="validation" for="serviceid">融云客服ID:</label></td>
        </tr>
        <tr class="noborder">
          <td class="vatop rowform"><input type="text" value="<?php echo $output['store_array']['serviceid'];?>" id="serviceid" name="serviceid" class="txt"></td>
          <td class="vatop tips"></td>
        </tr>
        <tr>
