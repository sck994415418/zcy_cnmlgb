...
$arr = array(
    ...
    'left' => array(
        ...
        2 => array(
            ...
            'text' => $lang['nc_goods'],
            'list' => array(
                array('args' => 'index,goods_orm,goods', 'text' => "商品映射"),
                array('args' => 'index,zf_class,goods', 'text' => "政采分类"),
                ...
                array('args' => 'title,title,goods', 'text' => "主题管理"),
                ...
                array('args' => 'index,rent_goods,goods', 'text' => '租赁商品管理'),
            )
        ),
        3 => array(
            'nav' => 'store',
        ...
        5 => array(
            ...
            'list' => array(
                ...
                //array('args' => 'index,vr_order,trade', 'text' => '维修订单'),
                array('args' => 'indexgodos,rent,trade', 'text' => '租赁订单'),
                ...
                array('args' => 'indexs,order,trade', 'text' => "师傅提现管理"),
            )
        ),
        6 => array(
            'nav' => 'website',
...
// array('args'=>'newmember,stat_member,stat',			'text'=>$lang['nc_statmember']),
                ...
                array('args' => 'sale,stat_trade,stat', 'text' => $lang['nc_stattrade']),
...
if (C('microshop_isuse') !== null) {
    ...
    $arr['left'][] = array(
        ...
        'text' => $lang['nc_rent'],
        'list' => array(
            0 => array('args' => 'rent_type,rent,rent', 'text' => $lang['nc_equip_type']),
            1 => array('args' => 'equip,rent,rent', 'text' => $lang['nc_rent_equip']),
            2 => array('args' => 'rent_lists,rent,rent', 'text' => $lang['nc_rent_info']),
        )
    );
}
